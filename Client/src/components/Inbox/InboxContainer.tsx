...
//         localStorage.getItem("selectedSubModuleId") || ""
//     );

//     const [selectedSubModuleName, setSelectedSubModuleName] = useState<string>(
//         localStorage.getItem("selectedSubModuleName") || ""
//     );

//     const [selectedInstance, setSelectedInstance] =
//         useState<InstanceItem | null>(null);
...
//         localStorage.removeItem("selectedSubModuleName");
...
//                 let initial = modules.find(
//                     (m) => String(m.PackageProcessMapId) === selectedSubModule
//                 );

//                 if (!initial && modules.length > 0) {
...
//             localStorage.setItem("selectedSubModuleId", subModuleId);
//             localStorage.setItem(
//                 "selectedSubModuleName",
...
//         const url = `/${instance.ProcessPath}?instanceId=${instance.InstanceId}&isSideBar=false`;

//         setIframeUrl(url);

//         localStorage.setItem("activeIframeUrl", url);
...
//                         <option
//                             key={PackageProcessMapId}
//                             value={PackageProcessMapId}
//                         >
//                             {ProcessName}
//                         </option>
//                     ))}
...
//                                 className={`inb-inbox-list ${selectedInstance?.InstanceId === item.InstanceId
//                                         ? "active"
//                                         : ""
//                                     }`}
...
//                                 {selectedSubModuleName || "None"} -{" "}
//                                 {selectedInstance?.Description ||
//                                     selectedInstance?.TaskName ||
//                                     "None"}
//                             </h5>
//                         </div>
                ...
                {selectedInstance && selectedModuleId ? (
                    ...
                    <div className="inb-nodata">
                        <div style={{ width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}>
                            ...
                            <img height={450} src="http://210.18.135.72/iProofCDN/Templates/Default/Styles/LTR/assets/images/Education/nodata.png" />
