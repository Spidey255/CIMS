...
//   const formInstanceId = usePageStore(
//     (store) => store.formInstanceId
//   );
...
//       // const params = details["Params"] ? JSON.parse(details["Params"]) as IActionParams[] : [];
...
//       const getActualElementName = (elementName: string) => {
//         if (elementName.includes("+")) {
//           return elementName.split("+").pop(); // last part
//         }
//         return elementName;
//       };
...
//         if (redirectionInfo[0].RedirectType === RedirectType.INTERNAL_REDIRECT) {
//           const url = redirectionInfo[0].Value.toString().trim()
//           const queryString = url.split('?')[1];

//           if (!queryString) return console.log("No query string found in redirection URL");

//           const params = Object.fromEntries(new URLSearchParams(queryString));

//           const page = pages.find((p) => p.ProcessActivityMapId === params.PkActMId);

//           if (page) {
//             navigate(`/${page.ProcessName}`);
//           }
//           // navigate(redirectionInfo[0].Value.toString().trim().split(" ").join(""));
//         }
//         if (redirectionInfo[0].RedirectType === RedirectType.EXTERNAL_REDIRECT) {
//           window.open(redirectionInfo[0].Value! as string, "_blank");
//         };
//       }
