...
{
ISpace["UI_BankPanel"].Visible="false";
}
...
if(ISpace["FormVersionId"].Value=="817AE0D5-4499-4C2A-9284-F655B64E42CE")
{
ISpace["UI_HideAmountPanel"].Visible="false";
}if(ISpace["FormVersionId"].Value=="817AE0D5-4499-4C2A-9284-F655B64E42CE")
{
ISpace["UI_HideFundColumn"].Visible="false";
}
base.WriteDebugInfo(@"if(ISpace[""FormVersionId""].Value==""817AE0D5-4499-4C2A-9284-F655B64E42CE"")
{
ISpace[""UI_HideAmountPanel""].Visible=""false"";
...
object MG_Amount=iSpace.Sum("[AD9C54EC-27A0-4C21-9923-063084E3B588]","MG_Amount","");
ISpace["M_SumOfFund"].Value=Convert.ChangeType(MG_Amount, MG_Amount.GetType());;
base.WriteDebugInfo(@"object MG_Amount=iSpace.Sum(""[AD9C54EC-27A0-4C21-9923-063084E3B588]"",""MG_Amount"","""");
ISpace[""M_SumOfFund""].Value=Convert.ChangeType(MG_Amount, MG_Amount.GetType());;");
if(1==1)
{
base.WriteDebugInfo(@"if(1==1)");
...
object MG_FundType=iSpace.Count("[AD9C54EC-27A0-4C21-9923-063084E3B588]","MG_FundType","");
ISpace["MF_GrdFundCount"].Value=Convert.ChangeType(MG_FundType, MG_FundType.GetType());;
base.WriteDebugInfo(@"object MG_FundType=iSpace.Count(""[AD9C54EC-27A0-4C21-9923-063084E3B588]"",""MG_FundType"","""");
ISpace[""MF_GrdFundCount""].Value=Convert.ChangeType(MG_FundType, MG_FundType.GetType());;");
...
object M_DocumentDetailsId=iSpace.Count("[B5EF84C8-83A9-4B1C-9431-0489F9EC063B]","M_DocumentDetailsId","");
ISpace["MF_CountDoc"].Value= Convert.ChangeType(M_DocumentDetailsId, M_DocumentDetailsId.GetType());;
base.WriteDebugInfo(@"object M_DocumentDetailsId=iSpace.Count(""[B5EF84C8-83A9-4B1C-9431-0489F9EC063B]"",""M_DocumentDetailsId"","""");
ISpace[""MF_CountDoc""].Value= Convert.ChangeType(M_DocumentDetailsId, M_DocumentDetailsId.GetType());;");
...
var RemarksDomain_ActivityTrailLogDetails_rows = GetElementClientData(ISpace["InstanceId"].Value,"EE0139AD-5EB8-4786-96CB-2C87A8B572D9");
...
if(rows.ContainsKey("75F146E5-6984-4A81-88F0-038462EFC746"))     elementData = rows["75F146E5-6984-4A81-88F0-038462EFC746"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ProcessedInProgressFlag",false,false,5);
...
if(rows.ContainsKey("C24EEFCE-3ED6-4599-9D53-BC8C9FAAC5B6"))     elementData = rows["C24EEFCE-3ED6-4599-9D53-BC8C9FAAC5B6"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"InstanceID",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("11A123AD-CEAD-415D-9ED9-470F68588552"))     elementData = rows["11A123AD-CEAD-415D-9ED9-470F68588552"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DestinationActivityMapID",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("EBD2F722-23C9-4B7D-B0A6-C61CB2373EC8"))     elementData = rows["EBD2F722-23C9-4B7D-B0A6-C61CB2373EC8"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Remarks",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("2E715862-3A36-4412-BAD9-91CB1CAA8F60"))     elementData = rows["2E715862-3A36-4412-BAD9-91CB1CAA8F60"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"SourceActivityMapID",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
base.WriteDebugInfo(@"Entering DomainDataMap for UserRequests");
var UserRequests_repoObj = new RepositoryMapper(DbTypes.SQLServer);


var UserRequestsUserRequeststableObj = new RepositoryTable("UserRequests");
  UserRequestsUserRequeststableObj.AppConnectionSettingsId  ="9ADED37B-CD11-426B-AF16-DEAC75685EF5";UserRequestsUserRequeststableObj.ProofConnectionId = "C3BEA3AF-C9B7-4DEA-AE35-EA1C626191C0)";
var UserRequests_UserRequests_rows = GetElementClientData(ISpace["InstanceId"].Value,"EE0139AD-5EB8-4786-96CB-2C87A8B572D9");

if(UserRequests_UserRequests_rows!=null && UserRequests_UserRequests_rows.Count>0){
var UserRequests_UserRequests_rowsObj = new List<RepositoryRow>();
foreach(var rows in UserRequests_UserRequests_rows){RepositoryRow repositoryRowObj = null;string elementData = null;RepositoryColumn repositoryColumnObj = null;if(rows !=null){ var UserRequests_colObj = new List<RepositoryColumn>();repositoryRowObj= new RepositoryRow();//var myByte = (byte)rowData.Value.RwSt;//repositoryRowObj.RowState=(RepositoryRowState)myByte;
...
if(rows.ContainsKey("511BB977-B0F3-4C6B-AD94-5EEC58847E51"))     elementData = rows["511BB977-B0F3-4C6B-AD94-5EEC58847E51"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"CurrentLevel",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_NextStage not found");}

if(rows.ContainsKey("CF4CCB19-095F-4BD0-846D-821A7F2C00E6"))     elementData = rows["CF4CCB19-095F-4BD0-846D-821A7F2C00E6"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"RequestID",false,true,5);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_RequestId not found");}

if(rows.ContainsKey("062CA7A9-6EC4-4B17-A93E-BA18BEA61869"))     elementData = rows["062CA7A9-6EC4-4B17-A93E-BA18BEA61869"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"CurrentStatus",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("11A123AD-CEAD-415D-9ED9-470F68588552"))     elementData = rows["11A123AD-CEAD-415D-9ED9-470F68588552"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"CurrentActivityMapID",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-SetDestinationTo not found");}

if(rows.ContainsKey("C24EEFCE-3ED6-4599-9D53-BC8C9FAAC5B6"))     elementData = rows["C24EEFCE-3ED6-4599-9D53-BC8C9FAAC5B6"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"InstanceID",true,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_InstanceId not found");}
...
if(rows.ContainsKey("03150A9B-AB06-4AA8-BF1B-B1FE3C640CF3"))     elementData = rows["03150A9B-AB06-4AA8-BF1B-B1FE3C640CF3"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"RequestTitle",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-Subject not found");}
repositoryRowObj.Columns=UserRequests_colObj;
UserRequests_UserRequests_rowsObj.Add(repositoryRowObj);
}}

UserRequestsUserRequeststableObj.Rows=UserRequests_UserRequests_rowsObj;
var UserRequests_repoObj_status_UserRequests = UserRequests_repoObj.Execute(DomainOperationTypes.CreateOrUpdate,ref UserRequestsUserRequeststableObj);if(!UserRequests_repoObj_status_UserRequests) throw new Exception("Error in Execute Domain Data Map");}
base.WriteDebugInfo(@"Exiting DomainDataMap for UserRequests");
}
...
{
base.WriteDebugInfo(@"if(1==1)");
object MG_T3_Amount=iSpace.Sum("[A694A330-AAD5-4856-853C-D6AD1573AF0B]","MG_T3_Amount","");
ISpace["T_ExpenditureTotal"].Value=Convert.ChangeType(MG_T3_Amount, MG_T3_Amount.GetType());;
base.WriteDebugInfo(@"object MG_T3_Amount=iSpace.Sum(""[A694A330-AAD5-4856-853C-D6AD1573AF0B]"",""MG_T3_Amount"","""");
ISpace[""T_ExpenditureTotal""].Value=Convert.ChangeType(MG_T3_Amount, MG_T3_Amount.GetType());;");
}
}
catch(Exception ex)
...
if(ISpace["FormVersionId"].Value=="817AE0D5-4499-4C2A-9284-F655B64E42CE")
{
ISpace["UI_HidePanelBodyYes"].Visible="true";
}
base.WriteDebugInfo(@"if(ISpace[""FormVersionId""].Value==""817AE0D5-4499-4C2A-9284-F655B64E42CE"")
{
ISpace[""UI_HidePanelBodyYes""].Visible=""true"";
...
if(ISpace["FormVersionId"].Value=="817AE0D5-4499-4C2A-9284-F655B64E42CE")
{
ISpace["UI_HidePanelBodyYes"].Visible="false";
}
base.WriteDebugInfo(@"if(ISpace[""FormVersionId""].Value==""817AE0D5-4499-4C2A-9284-F655B64E42CE"")
{
ISpace[""UI_HidePanelBodyYes""].Visible=""false"";
...
object MG_T2_Amount=iSpace.Sum("[FA412DDD-7AD9-49AF-B8D7-2B7E1620D8FC]","MG_T2_Amount","");
ISpace["T_TravelAdvanceTotal"].Value=Convert.ChangeType(MG_T2_Amount, MG_T2_Amount.GetType());;
base.WriteDebugInfo(@"object MG_T2_Amount=iSpace.Sum(""[FA412DDD-7AD9-49AF-B8D7-2B7E1620D8FC]"",""MG_T2_Amount"","""");
ISpace[""T_TravelAdvanceTotal""].Value=Convert.ChangeType(MG_T2_Amount, MG_T2_Amount.GetType());;");
...
var TravelAdvanceFundDetails_TravelAdvanceFundDetails_rows = GetElementClientData(ISpace["InstanceId"].Value,"EE0139AD-5EB8-4786-96CB-2C87A8B572D9");
...
if(rows.ContainsKey("09C67CA4-231A-41FC-8154-56BC80CC4F21"))     elementData = rows["09C67CA4-231A-41FC-8154-56BC80CC4F21"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ProjectDetailsId",false,false,9);
...
if(rows.ContainsKey("0005D02F-5139-4E1C-8C23-D3B2CB730129"))     elementData = rows["0005D02F-5139-4E1C-8C23-D3B2CB730129"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TravelInstanceId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("67339763-8E5A-4842-8D98-F9839DA75D5F"))     elementData = rows["67339763-8E5A-4842-8D98-F9839DA75D5F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"FundDetailsId",true,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_FundDetailsId not found");}

if(rows.ContainsKey("38E178F2-3EEE-4B09-99C6-3D0E730AB23F"))     elementData = rows["38E178F2-3EEE-4B09-99C6-3D0E730AB23F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"FundTypeId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("4A68A9B9-F65D-4E1E-AC9E-7299A2DA58C9"))     elementData = rows["4A68A9B9-F65D-4E1E-AC9E-7299A2DA58C9"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"BudgetHeadId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_BudgetHead not found");}

if(rows.ContainsKey("7F5285EB-9B6B-4535-9B47-8A80DF8FBB70"))     elementData = rows["7F5285EB-9B6B-4535-9B47-8A80DF8FBB70"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Amount",false,false,3);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
base.WriteDebugInfo(@"Entering DomainDataMap for UserRequests for other Steps");
var UserRequestsforotherSteps_repoObj = new RepositoryMapper(DbTypes.SQLServer);


var UserRequestsUserRequestsforotherStepstableObj = new RepositoryTable("UserRequests");
  UserRequestsUserRequestsforotherStepstableObj.AppConnectionSettingsId  ="9ADED37B-CD11-426B-AF16-DEAC75685EF5";UserRequestsUserRequestsforotherStepstableObj.ProofConnectionId = "C3BEA3AF-C9B7-4DEA-AE35-EA1C626191C0)";
var UserRequestsforotherSteps_UserRequests_rows = GetElementClientData(ISpace["InstanceId"].Value,"EE0139AD-5EB8-4786-96CB-2C87A8B572D9");

if(UserRequestsforotherSteps_UserRequests_rows!=null && UserRequestsforotherSteps_UserRequests_rows.Count>0){
var UserRequestsforotherSteps_UserRequests_rowsObj = new List<RepositoryRow>();
foreach(var rows in UserRequestsforotherSteps_UserRequests_rows){RepositoryRow repositoryRowObj = null;string elementData = null;RepositoryColumn repositoryColumnObj = null;if(rows !=null){ var UserRequests_colObj = new List<RepositoryColumn>();repositoryRowObj= new RepositoryRow();//var myByte = (byte)rowData.Value.RwSt;//repositoryRowObj.RowState=(RepositoryRowState)myByte;
...
repositoryRowObj.Columns=UserRequests_colObj;
UserRequestsforotherSteps_UserRequests_rowsObj.Add(repositoryRowObj);
}}

UserRequestsUserRequestsforotherStepstableObj.Rows=UserRequestsforotherSteps_UserRequests_rowsObj;
var UserRequestsforotherSteps_repoObj_status_UserRequests = UserRequestsforotherSteps_repoObj.Execute(DomainOperationTypes.Update,ref UserRequestsUserRequestsforotherStepstableObj);if(!UserRequestsforotherSteps_repoObj_status_UserRequests) throw new Exception("Error in Execute Domain Data Map");}
base.WriteDebugInfo(@"Exiting DomainDataMap for UserRequests for other Steps");
ISpace["Message"].Value=@"Submitted Successfully";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Submitted Successfully"";");
ISpace.ExecuteInstanceCommand("Submit");
base.WriteDebugInfo(@"ISpace.ExecuteInstanceCommand(""Submit"");");
