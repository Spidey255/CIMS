    ...
    {		
       ...
       // {
		...
		private List<Triplet<string, string, string>> ComboDataSource = new List<Triplet<string, string, string>>
		{
			     ...
			     new Triplet<string, string, string>("MF_T1_TravelType","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"Select 1,1"),
			
						
			     new Triplet<string, string, string>("MG_T2_ModeofJourney","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 4"),
			
						
			     new Triplet<string, string, string>("C_FC_ProjectNo_33","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"SELECT InstanceID,ProjectCode FROM CreateprojectDetails WITH(NOLOCK) WHERE ProjectStatus='9'"),
			
						
			     new Triplet<string, string, string>("MFG_T2_ExpenditureTypeID","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceView 3,''"),
			
						
			     new Triplet<string, string, string>("MFG_T2_ModeofJourney","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 4"),
			
						
			     new Triplet<string, string, string>("MG_L1_Expenditure_Type","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceView 3,''"),
			
						
			     new Triplet<string, string, string>("Expenditure_Type","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceView 3,''"),
			
						
			     new Triplet<string, string, string>("MG_T2_JourneyClass","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 17,''"),
			
						
			     new Triplet<string, string, string>("R_ReferenceNo","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"Exec GetTravelSettlement 5,'','@UC_EmployeeBaicInfoID'"),
			
						
			     new Triplet<string, string, string>("MF_BudgetHead","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77cc4eTVUER6yxhHgktDkfvWfwBNgoOezuhR3VTahYodgYs1XIsswI0A==",
			     ...
			     new Triplet<string, string, string>("MG_L1_JourneyClass","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 17,''"),
			
						
			     new Triplet<string, string, string>("MG_T2_DepartureTime","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 6"),
			
						
			     new Triplet<string, string, string>("A","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77cc4eTVUER6yxhHgktDkfvWfwBNgoOezuhR3VTahYodgYs1XIsswI0A==",
												     @"exec SP_GetDistrubitionDetails 5,'',@MF_FundType,''"),
			
						
			     new Triplet<string, string, string>("MG_T2_ArrivalTime","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 6"),
			
						
			     new Triplet<string, string, string>("MFG_T2_JourneyClass","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 7,'@MFG_T2_ModeofJourney'"),
			
						
			     new Triplet<string, string, string>("MF_T1_BudgetHead","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"SELECT BudgetID,BudgetName FROM BudgetHead WITH(NOLOCK)"),
			     ...
			     new Triplet<string, string, string>("MF_FundType","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77cc4eTVUER6yxhHgktDkfvWfwBNgoOezuhR3VTahYodgYs1XIsswI0A==",
												     @"exec SP_GetDistrubitionDetails 7,'@@gv_ProcessMapId','','',@MF_T1_AdvanceAmount,'','@R_ReferenceNo',''"),
			
						
			     new Triplet<string, string, string>("MG_L1_ModeofJourney","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77XPhhEPANfatU8lJP0mJJjSopgrwrPOlAa7ekRdWJpCoSneyUlDBd6d1RrcOybG3s",
												     @"EXEC GetTravelAdvanceDetailCombo 4"),
			     ...
			     new Triplet<string, string, string>("Travel_Type","Z4IrlPTfl7E3UHhZKuDmi6JCY+YHcA863SqFhgUyVVzIeVWsNWiw1z/z9sf1712IST2TisZRbDL01cRO080NYHWsKvkYJS77cc4eTVUER6yxhHgktDkfvWfwBNgoOezuhR3VTahYodgYs1XIsswI0A==",
												     @"SELECT Sequence,DictionaryValue FROM Common..GlobalDictionary where Category='projectType'"),
			...
			switch(processActivityMapId)	
				{
							...
							break;
											...
											case "8e7d1be4-e590-2705-0245-3782073ff3d2":
							virtualInstance=new ISpace8e7d1be4e590270502453782073ff3d2();
							break;
					
											case "4a093f4e-d96c-27c0-87db-6b043aed97dc":
							virtualInstance=new ISpace4a093f4ed96c27c087db6b043aed97dc();
							break;
					
											case "7d998690-8c45-0a15-1172-1969d4aafed7":
							virtualInstance=new ISpace7d9986908c450a1511721969d4aafed7();
							break;
					
											case "0d7fa7ef-8c70-66b3-f172-1782236c8888":
							virtualInstance=new ISpace0d7fa7ef8c7066b3f1721782236c8888();
							break;
...
{
base.WriteDebugInfo(@"if(1==1)");
ISpace["M_ActualTransactionNo"].Value=RegularExpression(ISpace["M_ActualTransactionNo"].Value,"^[a-zA-Z0-9'-]+$","0");
base.WriteDebugInfo(@"ISpace[""M_ActualTransactionNo""].Value=RegularExpression(ISpace[""M_ActualTransactionNo""].Value,""^[a-zA-Z0-9'-]+$"",""0"");");
...
object MG_FundType=iSpace.Count("[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5]","MG_FundType","");
ISpace["MF_GrdFundCount"].Value=Convert.ChangeType(MG_FundType, MG_FundType.GetType());;
base.WriteDebugInfo(@"object MG_FundType=iSpace.Count(""[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5]"",""MG_FundType"","""");
ISpace[""MF_GrdFundCount""].Value=Convert.ChangeType(MG_FundType, MG_FundType.GetType());;");
...
object M_DocumentDetailsId=iSpace.Count("[2624976A-0052-420C-8D20-F5C9444C7A48]","M_DocumentDetailsId","");
ISpace["MF_CountDoc"].Value= Convert.ChangeType(M_DocumentDetailsId, M_DocumentDetailsId.GetType());;
base.WriteDebugInfo(@"object M_DocumentDetailsId=iSpace.Count(""[2624976A-0052-420C-8D20-F5C9444C7A48]"",""M_DocumentDetailsId"","""");
ISpace[""MF_CountDoc""].Value= Convert.ChangeType(M_DocumentDetailsId, M_DocumentDetailsId.GetType());;");
if(1==1)
{
base.WriteDebugInfo(@"if(1==1)");
...
var Repo198E5A8A61F54E7C92DD34146A7059EF_TravelAdvance_rows = GetElementClientData(ISpace["InstanceId"].Value,"22A823DE-0760-4F0D-A347-1C1315A2967E");
...
if(rows.ContainsKey("8635a8af-9db3-0f62-e396-52acc63315cd"))     elementData = rows["8635a8af-9db3-0f62-e396-52acc63315cd"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TSTransactionDate",false,false,8);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_ActualTransactionDate not found");}

if(rows.ContainsKey("8635a8af-9db3-0f62-e396-52acc63315cd"))     elementData = rows["8635a8af-9db3-0f62-e396-52acc63315cd"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"PITransactionDate",false,false,8);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_ActualTransactionDate not found");}

if(rows.ContainsKey("5772fbfa-3238-bb68-42c2-960b0a9c21b8"))     elementData = rows["5772fbfa-3238-bb68-42c2-960b0a9c21b8"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TravelAdvanceID",true,false,9);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-R_ReferenceNo not found");}

if(rows.ContainsKey("277901dd-8bed-5ad5-f64a-9fbfea73e060"))     elementData = rows["277901dd-8bed-5ad5-f64a-9fbfea73e060"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TSTransactionNo",false,false,9);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_RandDTransactionNo not found");}

if(rows.ContainsKey("E93D18CB-89CB-4454-A768-D3B044756969"))     elementData = rows["E93D18CB-89CB-4454-A768-D3B044756969"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TSAmount",false,false,3);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-OverAll_Total not found");}

if(rows.ContainsKey("4BE1B8AF-8297-4902-A3FD-50A820E95B55"))     elementData = rows["4BE1B8AF-8297-4902-A3FD-50A820E95B55"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TSStatus",false,false,9);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_TravelStatus not found");}

if(rows.ContainsKey("9ad5868a-6ff0-d642-01b0-663ab442f01e"))     elementData = rows["9ad5868a-6ff0-d642-01b0-663ab442f01e"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"PITransactionNo",false,false,9);
if(repositoryColumnObj!=null)TravelAdvance_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_ActualTransactionNo not found");}
...
var Repo198E5A8A61F54E7C92DD34146A7059EF_repoObj_status_TravelAdvance = Repo198E5A8A61F54E7C92DD34146A7059EF_repoObj.Execute(DomainOperationTypes.Update,ref TravelAdvanceRepo198E5A8A61F54E7C92DD34146A7059EFtableObj);if(!Repo198E5A8A61F54E7C92DD34146A7059EF_repoObj_status_TravelAdvance) throw new Exception("Error in Execute Domain Data Map");}
...
var Repo374fb8a88dd94cf1bf73f40ae18fcad7_TravelAdvanceDetails_rows = GetElementClientData(ISpace["InstanceId"].Value,"9F49372F-0255-42EC-AB05-31E6C4F9F2EA");
...
if(rows.ContainsKey("291df147-643c-54d5-67b6-69fe8c116e5e"))     elementData = rows["291df147-643c-54d5-67b6-69fe8c116e5e"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"IsTravelRequest",false,false,5);
...
if(rows.ContainsKey("6CE992A4-D84B-4B18-84C8-9BB950C07C21"))     elementData = rows["6CE992A4-D84B-4B18-84C8-9BB950C07C21"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TADetailsID",true,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("B9572CBB-828E-4B17-8B9B-676C24B9EE73"))     elementData = rows["B9572CBB-828E-4B17-8B9B-676C24B9EE73"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DepartureDate",false,false,8);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_DepartureDate not found");}

if(rows.ContainsKey("79EFEC01-BDB8-4BF8-9B60-BD6FABDC1695"))     elementData = rows["79EFEC01-BDB8-4BF8-9B60-BD6FABDC1695"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DepartureTime",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_DepartureTime not found");}

if(rows.ContainsKey("FB7901A3-6B1A-4703-87F6-CB9F4521B5CC"))     elementData = rows["FB7901A3-6B1A-4703-87F6-CB9F4521B5CC"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ArrivalDate",false,false,8);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_ArrivalDate not found");}

if(rows.ContainsKey("91A6A5AB-7C84-4FE5-942E-E4625E206FDD"))     elementData = rows["91A6A5AB-7C84-4FE5-942E-E4625E206FDD"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Road",false,false,5);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_Road not found");}

if(rows.ContainsKey("5772fbfa-3238-bb68-42c2-960b0a9c21b8"))     elementData = rows["5772fbfa-3238-bb68-42c2-960b0a9c21b8"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TravelAdvanceID",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-R_ReferenceNo not found");}

if(rows.ContainsKey("45AE67E9-3CF6-4A96-B4CD-E5931A8D394C"))     elementData = rows["45AE67E9-3CF6-4A96-B4CD-E5931A8D394C"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Departure",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_Departure not found");}

if(rows.ContainsKey("7341FB05-8646-489A-A793-CF7D1749BBFA"))     elementData = rows["7341FB05-8646-489A-A793-CF7D1749BBFA"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Amount",false,false,5);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_Amount not found");}

if(rows.ContainsKey("44BDCB41-8AD3-4B4F-A138-8A91F72EB42E"))     elementData = rows["44BDCB41-8AD3-4B4F-A138-8A91F72EB42E"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"JourneyClass",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_JourneyClass not found");}

if(rows.ContainsKey("E88766A7-0FA6-4264-8346-C8D80A04C31A"))     elementData = rows["E88766A7-0FA6-4264-8346-C8D80A04C31A"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Arrival",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_Arrival not found");}

if(rows.ContainsKey("FCF97BDE-A51B-4C5D-800D-144E535BEDF2"))     elementData = rows["FCF97BDE-A51B-4C5D-800D-144E535BEDF2"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"PNRNo",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_PNRNo not found");}

if(rows.ContainsKey("19CC7973-ED5E-42E4-8022-D3B2EA0FC6E5"))     elementData = rows["19CC7973-ED5E-42E4-8022-D3B2EA0FC6E5"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ModeofJourney",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_ModeofJourney not found");}

if(rows.ContainsKey("904993D2-F9D4-4365-9AC2-9C3F23BD8ADE"))     elementData = rows["904993D2-F9D4-4365-9AC2-9C3F23BD8ADE"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ArrivalTime",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
var Repo51838b372ec64d358a5e38648bc93ab1_TravelAdvance_ExpenditureType_rows = GetElementClientData(ISpace["InstanceId"].Value,"7D2812B7-3A49-4DA7-9E48-082B26C3333C");
...
if(rows.ContainsKey("3f26a2e5-667f-96b7-4539-20ed21dadbf5"))     elementData = rows["3f26a2e5-667f-96b7-4539-20ed21dadbf5"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"OtherExpenditureType",false,false,9);
if(repositoryColumnObj!=null)TravelAdvance_ExpenditureType_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_MiscDetails not found");}

if(rows.ContainsKey("B8484B50-E784-48C7-89B2-8F9BEEBE3A5B"))     elementData = rows["B8484B50-E784-48C7-89B2-8F9BEEBE3A5B"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ToDate",false,false,8);
if(repositoryColumnObj!=null)TravelAdvance_ExpenditureType_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_ToDate not found");}

if(rows.ContainsKey("B218C6DE-EC82-4740-8E0A-A7501288D41F"))     elementData = rows["B218C6DE-EC82-4740-8E0A-A7501288D41F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"FromDate",false,false,8);
if(repositoryColumnObj!=null)TravelAdvance_ExpenditureType_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("92533FD6-C635-4DA2-A804-320749FAAB3A"))     elementData = rows["92533FD6-C635-4DA2-A804-320749FAAB3A"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ExpenditureTypeID",true,false,9);
if(repositoryColumnObj!=null)TravelAdvance_ExpenditureType_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MG_T2_ExpenditureTypeID not found");}

if(rows.ContainsKey("41BC109B-7900-4252-A993-388D22496A31"))     elementData = rows["41BC109B-7900-4252-A993-388D22496A31"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ExpenditureType",false,false,9);
if(repositoryColumnObj!=null)TravelAdvance_ExpenditureType_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-Expenditure_Type not found");}

if(rows.ContainsKey("C9744A0D-89F7-42E4-8C96-FEF7424C5BB1"))     elementData = rows["C9744A0D-89F7-42E4-8C96-FEF7424C5BB1"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Amount",false,false,5);
if(repositoryColumnObj!=null)TravelAdvance_ExpenditureType_colObj.Add(repositoryColumnObj);elementData = null;}
...
var DocumentsDomain_DocumentDetails_rows = GetElementClientData(ISpace["InstanceId"].Value,"2624976A-0052-420C-8D20-F5C9444C7A48");
...
if(rows.ContainsKey("49F9C143-EBB3-4E8F-8D2A-7E6798278A69"))     elementData = rows["49F9C143-EBB3-4E8F-8D2A-7E6798278A69"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DocumentDetailsId",true,false,9);
...
if(rows.ContainsKey("930508FE-EA43-4620-89DC-383D11E12288"))     elementData = rows["930508FE-EA43-4620-89DC-383D11E12288"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"PackageProcessMappingId",false,false,9);
if(repositoryColumnObj!=null)DocumentDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("2E1076AA-440A-4414-BAE1-8441D30FF100"))     elementData = rows["2E1076AA-440A-4414-BAE1-8441D30FF100"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DocumentName",false,false,9);
if(repositoryColumnObj!=null)DocumentDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("FE6042BC-68DA-4AC9-B822-8E8C268DDB91"))     elementData = rows["FE6042BC-68DA-4AC9-B822-8E8C268DDB91"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DocumentId",false,false,6);
if(repositoryColumnObj!=null)DocumentDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_UploadDcoument not found");}

if(rows.ContainsKey("5772fbfa-3238-bb68-42c2-960b0a9c21b8"))     elementData = rows["5772fbfa-3238-bb68-42c2-960b0a9c21b8"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"InstanceId",false,false,9);
if(repositoryColumnObj!=null)DocumentDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-R_ReferenceNo not found");}
...
var RemarksDomain_ActivityTrailLogDetails_rows = GetElementClientData(ISpace["InstanceId"].Value,"22A823DE-0760-4F0D-A347-1C1315A2967E");
...
if(rows.ContainsKey("546760D8-15E4-4B46-AB3A-EFD9E5454D1F"))     elementData = rows["546760D8-15E4-4B46-AB3A-EFD9E5454D1F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ProcessedInProgressFlag",false,false,5);
...
if(rows.ContainsKey("8D193DD4-9227-46B0-992C-3E7C4B55D2F4"))     elementData = rows["8D193DD4-9227-46B0-992C-3E7C4B55D2F4"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"InstanceID",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("FCE9204C-05C1-4140-9D62-77851E98A25F"))     elementData = rows["FCE9204C-05C1-4140-9D62-77851E98A25F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"DestinationActivityMapID",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("95C95993-EDCB-49BB-A1B2-CCE53BEF176D"))     elementData = rows["95C95993-EDCB-49BB-A1B2-CCE53BEF176D"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Remarks",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_Remarks not found");}
...
if(rows.ContainsKey("6966F448-129B-4C47-8F58-7EC058B546DD"))     elementData = rows["6966F448-129B-4C47-8F58-7EC058B546DD"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"SourceActivityMapID",false,false,9);
if(repositoryColumnObj!=null)ActivityTrailLogDetails_colObj.Add(repositoryColumnObj);elementData = null;}
...
base.WriteDebugInfo(@"Entering DomainDataMap for User Request");
var UserRequest_repoObj = new RepositoryMapper(DbTypes.SQLServer);


var UserRequestsUserRequesttableObj = new RepositoryTable("UserRequests");
  UserRequestsUserRequesttableObj.AppConnectionSettingsId  ="9ADED37B-CD11-426B-AF16-DEAC75685EF5";UserRequestsUserRequesttableObj.ProofConnectionId = "C3BEA3AF-C9B7-4DEA-AE35-EA1C626191C0)";
var UserRequest_UserRequests_rows = GetElementClientData(ISpace["InstanceId"].Value,"22A823DE-0760-4F0D-A347-1C1315A2967E");

if(UserRequest_UserRequests_rows!=null && UserRequest_UserRequests_rows.Count>0){
var UserRequest_UserRequests_rowsObj = new List<RepositoryRow>();
foreach(var rows in UserRequest_UserRequests_rows){RepositoryRow repositoryRowObj = null;string elementData = null;RepositoryColumn repositoryColumnObj = null;if(rows !=null){ var UserRequests_colObj = new List<RepositoryColumn>();repositoryRowObj= new RepositoryRow();//var myByte = (byte)rowData.Value.RwSt;//repositoryRowObj.RowState=(RepositoryRowState)myByte;
...
if(rows.ContainsKey("290BDCEF-F7F9-47AC-8968-46E277FEC17F"))     elementData = rows["290BDCEF-F7F9-47AC-8968-46E277FEC17F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"CurrentLevel",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_NextStage not found");}

if(rows.ContainsKey("e347268c-1c38-5a35-4544-a478f3e27e41"))     elementData = rows["e347268c-1c38-5a35-4544-a478f3e27e41"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"RequestID",false,true,5);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_RequestId not found");}

if(rows.ContainsKey("b26147e3-86e1-defb-4303-3381e48b08d5"))     elementData = rows["b26147e3-86e1-defb-4303-3381e48b08d5"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"CurrentStatus",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
...
if(rows.ContainsKey("FCE9204C-05C1-4140-9D62-77851E98A25F"))     elementData = rows["FCE9204C-05C1-4140-9D62-77851E98A25F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"CurrentActivityMapID",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-SetDestinationTo not found");}

if(rows.ContainsKey("8D193DD4-9227-46B0-992C-3E7C4B55D2F4"))     elementData = rows["8D193DD4-9227-46B0-992C-3E7C4B55D2F4"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"InstanceID",true,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_InstanceId not found");}
...
if(rows.ContainsKey("DBB12624-6569-4051-9B44-C770F3F27A14"))     elementData = rows["DBB12624-6569-4051-9B44-C770F3F27A14"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"RequestTitle",false,false,9);
if(repositoryColumnObj!=null)UserRequests_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-Subject not found");}
repositoryRowObj.Columns=UserRequests_colObj;
UserRequest_UserRequests_rowsObj.Add(repositoryRowObj);
}}

UserRequestsUserRequesttableObj.Rows=UserRequest_UserRequests_rowsObj;
var UserRequest_repoObj_status_UserRequests = UserRequest_repoObj.Execute(DomainOperationTypes.CreateOrUpdate,ref UserRequestsUserRequesttableObj);if(!UserRequest_repoObj_status_UserRequests) throw new Exception("Error in Execute Domain Data Map");}
base.WriteDebugInfo(@"Exiting DomainDataMap for User Request");
}
...
object MG_T2_Amount=iSpace.Sum("[9F49372F-0255-42EC-AB05-31E6C4F9F2EA]","MG_T2_Amount","");
ISpace["T_TravelAdvanceTotal"].Value=Convert.ChangeType(MG_T2_Amount, MG_T2_Amount.GetType());;
base.WriteDebugInfo(@"object MG_T2_Amount=iSpace.Sum(""[9F49372F-0255-42EC-AB05-31E6C4F9F2EA]"",""MG_T2_Amount"","""");
ISpace[""T_TravelAdvanceTotal""].Value=Convert.ChangeType(MG_T2_Amount, MG_T2_Amount.GetType());;");
...
object MG_Amount=iSpace.Sum("[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5]","MG_Amount","");
ISpace["M_SumOfFund"].Value=Convert.ChangeType(MG_Amount, MG_Amount.GetType());;
base.WriteDebugInfo(@"object MG_Amount=iSpace.Sum(""[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5]"",""MG_Amount"","""");
ISpace[""M_SumOfFund""].Value=Convert.ChangeType(MG_Amount, MG_Amount.GetType());;");
...
if(ISpace["FormVersionId"].Value=="7952C83C-2CDF-4039-A6A9-BF37615109C8")
{
ISpace["UI_TransactionPanel"].Visible="true";
}
base.WriteDebugInfo(@"if(ISpace[""FormVersionId""].Value==""7952C83C-2CDF-4039-A6A9-BF37615109C8"")
{
ISpace[""UI_TransactionPanel""].Visible=""true"";
...
if(ISpace["FormVersionId"].Value=="7952C83C-2CDF-4039-A6A9-BF37615109C8")
{
ISpace["UI_TransactionPanel"].Visible="false";
}
base.WriteDebugInfo(@"if(ISpace[""FormVersionId""].Value==""7952C83C-2CDF-4039-A6A9-BF37615109C8"")
{
ISpace[""UI_TransactionPanel""].Visible=""false"";
...
object MG_T3_Amount=iSpace.Sum("[7D2812B7-3A49-4DA7-9E48-082B26C3333C]","MG_T3_Amount","");
ISpace["T_ExpenditureTotal"].Value=Convert.ChangeType(MG_T3_Amount, MG_T3_Amount.GetType());;
base.WriteDebugInfo(@"object MG_T3_Amount=iSpace.Sum(""[7D2812B7-3A49-4DA7-9E48-082B26C3333C]"",""MG_T3_Amount"","""");
ISpace[""T_ExpenditureTotal""].Value=Convert.ChangeType(MG_T3_Amount, MG_T3_Amount.GetType());;");
ISpace["OverAll_Total"].Value=ISpace["T_TravelAdvanceTotal"].Value+ISpace["T_ExpenditureTotal"].Value;
base.WriteDebugInfo(@"ISpace[""OverAll_Total""].Value=ISpace[""T_TravelAdvanceTotal""].Value+ISpace[""T_ExpenditureTotal""].Value;");
object MG_Amount=iSpace.Sum("[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5]","MG_Amount","");
...
base.WriteDebugInfo(@"Entering DomainDataMap for TravelAdvanceFundDetails");
var TravelAdvanceFundDetails_repoObj = new RepositoryMapper(DbTypes.SQLServer);


var TravelAdvanceFundDetailsTravelAdvanceFundDetailstableObj = new RepositoryTable("TravelAdvanceFundDetails");
  TravelAdvanceFundDetailsTravelAdvanceFundDetailstableObj.AppConnectionSettingsId  ="3A103712-5244-4427-B2B6-1C4E046FD337";TravelAdvanceFundDetailsTravelAdvanceFundDetailstableObj.ProofConnectionId = "C3BEA3AF-C9B7-4DEA-AE35-EA1C626191C0)";
var TravelAdvanceFundDetails_TravelAdvanceFundDetails_rows = GetElementClientData(ISpace["InstanceId"].Value,"22A823DE-0760-4F0D-A347-1C1315A2967E");

if(TravelAdvanceFundDetails_TravelAdvanceFundDetails_rows!=null && TravelAdvanceFundDetails_TravelAdvanceFundDetails_rows.Count>0){
var TravelAdvanceFundDetails_TravelAdvanceFundDetails_rowsObj = new List<RepositoryRow>();
foreach(var rows in TravelAdvanceFundDetails_TravelAdvanceFundDetails_rows){RepositoryRow repositoryRowObj = null;string elementData = null;RepositoryColumn repositoryColumnObj = null;if(rows !=null){ var TravelAdvanceFundDetails_colObj = new List<RepositoryColumn>();repositoryRowObj= new RepositoryRow();//var myByte = (byte)rowData.Value.RwSt;//repositoryRowObj.RowState=(RepositoryRowState)myByte;

if(rows.ContainsKey("E3B05A49-1DC0-47EB-BB50-B53B14F1C72A"))     elementData = rows["E3B05A49-1DC0-47EB-BB50-B53B14F1C72A"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"ProjectDetailsId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_ProjectNo not found");}

if(rows.ContainsKey("1ddbffa4-0a85-a61c-116e-da1ca902ca28"))     elementData = rows["1ddbffa4-0a85-a61c-116e-da1ca902ca28"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TravelInstanceId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_TravelInstanceId not found");}

if(rows.ContainsKey("291df147-643c-54d5-67b6-69fe8c116e5e"))     elementData = rows["291df147-643c-54d5-67b6-69fe8c116e5e"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"IsTravelRequest",false,false,5);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-M_IsTravelRequest not found");}

if(rows.ContainsKey("FB884FDD-539D-4210-973B-82B3AC03928B"))     elementData = rows["FB884FDD-539D-4210-973B-82B3AC03928B"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"FundDetailsId",true,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_FundDetailsId not found");}

if(rows.ContainsKey("C613114C-6CFC-4FA7-8872-45D3B2189ACD"))     elementData = rows["C613114C-6CFC-4FA7-8872-45D3B2189ACD"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"FundTypeId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_FundType not found");}

if(rows.ContainsKey("5772fbfa-3238-bb68-42c2-960b0a9c21b8"))     elementData = rows["5772fbfa-3238-bb68-42c2-960b0a9c21b8"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"TravelAdvanceID",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-R_ReferenceNo not found");}

if(rows.ContainsKey("5A0D4E38-09C2-4339-94BA-FA9DAB4AE69F"))     elementData = rows["5A0D4E38-09C2-4339-94BA-FA9DAB4AE69F"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"BudgetHeadId",false,false,9);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_BudgetHead not found");}

if(rows.ContainsKey("2B16FA80-2364-46BD-BE98-2EBF5B91CA45"))     elementData = rows["2B16FA80-2364-46BD-BE98-2EBF5B91CA45"];if(elementData!=null){repositoryColumnObj=GetRepositoryColumnObject(elementData,"Amount",false,false,3);
if(repositoryColumnObj!=null)TravelAdvanceFundDetails_colObj.Add(repositoryColumnObj);elementData = null;}
else{base.WriteDebugInfo(@"Element-MF_Amount not found");}
repositoryRowObj.Columns=TravelAdvanceFundDetails_colObj;
TravelAdvanceFundDetails_TravelAdvanceFundDetails_rowsObj.Add(repositoryRowObj);
}}

TravelAdvanceFundDetailsTravelAdvanceFundDetailstableObj.Rows=TravelAdvanceFundDetails_TravelAdvanceFundDetails_rowsObj;
var TravelAdvanceFundDetails_repoObj_status_TravelAdvanceFundDetails = TravelAdvanceFundDetails_repoObj.Execute(DomainOperationTypes.CreateOrUpdate,ref TravelAdvanceFundDetailsTravelAdvanceFundDetailstableObj);if(!TravelAdvanceFundDetails_repoObj_status_TravelAdvanceFundDetails) throw new Exception("Error in Execute Domain Data Map");}
base.WriteDebugInfo(@"Exiting DomainDataMap for TravelAdvanceFundDetails");
...
base.WriteDebugInfo(@"Entering DomainDataMap for User Request For Other Step");
var UserRequestForOtherStep_repoObj = new RepositoryMapper(DbTypes.SQLServer);


var UserRequestsUserRequestForOtherSteptableObj = new RepositoryTable("UserRequests");
  UserRequestsUserRequestForOtherSteptableObj.AppConnectionSettingsId  ="9ADED37B-CD11-426B-AF16-DEAC75685EF5";UserRequestsUserRequestForOtherSteptableObj.ProofConnectionId = "C3BEA3AF-C9B7-4DEA-AE35-EA1C626191C0)";
var UserRequestForOtherStep_UserRequests_rows = GetElementClientData(ISpace["InstanceId"].Value,"22A823DE-0760-4F0D-A347-1C1315A2967E");

if(UserRequestForOtherStep_UserRequests_rows!=null && UserRequestForOtherStep_UserRequests_rows.Count>0){
var UserRequestForOtherStep_UserRequests_rowsObj = new List<RepositoryRow>();
foreach(var rows in UserRequestForOtherStep_UserRequests_rows){RepositoryRow repositoryRowObj = null;string elementData = null;RepositoryColumn repositoryColumnObj = null;if(rows !=null){ var UserRequests_colObj = new List<RepositoryColumn>();repositoryRowObj= new RepositoryRow();//var myByte = (byte)rowData.Value.RwSt;//repositoryRowObj.RowState=(RepositoryRowState)myByte;
...
repositoryRowObj.Columns=UserRequests_colObj;
UserRequestForOtherStep_UserRequests_rowsObj.Add(repositoryRowObj);
}}

UserRequestsUserRequestForOtherSteptableObj.Rows=UserRequestForOtherStep_UserRequests_rowsObj;
var UserRequestForOtherStep_repoObj_status_UserRequests = UserRequestForOtherStep_repoObj.Execute(DomainOperationTypes.Update,ref UserRequestsUserRequestForOtherSteptableObj);if(!UserRequestForOtherStep_repoObj_status_UserRequests) throw new Exception("Error in Execute Domain Data Map");}
base.WriteDebugInfo(@"Exiting DomainDataMap for User Request For Other Step");
ISpace["Message"].Value=@"Submitted Successfully";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Submitted Successfully"";");
ISpace.ExecuteInstanceCommand("Submit");
base.WriteDebugInfo(@"ISpace.ExecuteInstanceCommand(""Submit"");");
...
using System.Linq;using System.Data;
using System.Runtime.CompilerServices;
public class ISpace8e7d1be4e590270502453782073ff3d2 : VirtualForm
{
IISpace iSpace = new ISpace();
AcDataISpace8e7d1be4e590270502453782073ff3d2 acdataIspace8e7d1be4e590270502453782073ff3d2=new AcDataISpace8e7d1be4e590270502453782073ff3d2();
private void SubscribeFormEvents_root(ref Dictionary<string, ServiceElementData> ISpace)
{
try
{
...
List<Triplet<string, short, short?>> resultF6CCD46BA27D469EB390A56BFBF805A6=acdataIspace8e7d1be4e590270502453782073ff3d2.GetQueryExpressionBindings("F6CCD46B-A27D-469E-B390-A56BFBF805A6");
iSpace.SetGridData(result800FCB85CC5F45509D3F5D7AE4650DF2,resultF6CCD46BA27D469EB390A56BFBF805A6,"MG_RemarksDetails",ref ISpace);
iSpace.UpdateGridBindDetails("MG_RemarksDetails",resultF6CCD46BA27D469EB390A56BFBF805A6);
}
if(ISpace["Travel_Type"].Value=="1")
...
using System.Linq;using System.Data;
using System.Runtime.CompilerServices;
public class ISpace4a093f4ed96c27c087db6b043aed97dc : VirtualForm
{
IISpace iSpace = new ISpace();
AcDataISpace4a093f4ed96c27c087db6b043aed97dc acdataIspace4a093f4ed96c27c087db6b043aed97dc=new AcDataISpace4a093f4ed96c27c087db6b043aed97dc();
private void SubscribeFormEvents_root(ref Dictionary<string, ServiceElementData> ISpace)
{
try
{
...
List<Triplet<string, short, short?>> resultF6CCD46BA27D469EB390A56BFBF805A6=acdataIspace4a093f4ed96c27c087db6b043aed97dc.GetQueryExpressionBindings("F6CCD46B-A27D-469E-B390-A56BFBF805A6");
iSpace.SetGridData(result800FCB85CC5F45509D3F5D7AE4650DF2,resultF6CCD46BA27D469EB390A56BFBF805A6,"MG_RemarksDetails",ref ISpace);
iSpace.UpdateGridBindDetails("MG_RemarksDetails",resultF6CCD46BA27D469EB390A56BFBF805A6);
}
if(1==1)
...
using System.Linq;using System.Data;
using System.Runtime.CompilerServices;
public class ISpace7d9986908c450a1511721969d4aafed7 : VirtualForm
{
IISpace iSpace = new ISpace();
AcDataISpace7d9986908c450a1511721969d4aafed7 acdataIspace7d9986908c450a1511721969d4aafed7=new AcDataISpace7d9986908c450a1511721969d4aafed7();
private void SubscribeFormEvents_root(ref Dictionary<string, ServiceElementData> ISpace)
{
try
{
...
List<Triplet<string, short, short?>> resultF6CCD46BA27D469EB390A56BFBF805A6=acdataIspace7d9986908c450a1511721969d4aafed7.GetQueryExpressionBindings("F6CCD46B-A27D-469E-B390-A56BFBF805A6");
iSpace.SetGridData(result800FCB85CC5F45509D3F5D7AE4650DF2,resultF6CCD46BA27D469EB390A56BFBF805A6,"MG_RemarksDetails",ref ISpace);
iSpace.UpdateGridBindDetails("MG_RemarksDetails",resultF6CCD46BA27D469EB390A56BFBF805A6);
}
if(ISpace["Travel_Type"].Value=="1")
...
{
base.WriteDebugInfo(@"SubmitForm-OnClick");
ISpace["M_RandDTransactionNo"].Value=RegularExpression(ISpace["M_RandDTransactionNo"].Value,"^[a-zA-Z0-9'-]+$","0");
base.WriteDebugInfo(@"ISpace[""M_RandDTransactionNo""].Value=RegularExpression(ISpace[""M_RandDTransactionNo""].Value,""^[a-zA-Z0-9'-]+$"",""0"");");
if(ISpace["M_RandDTransactionNo"].Value=="")
{
base.WriteDebugInfo(@"if(ISpace[""M_RandDTransactionNo""].Value=="""")");
ISpace["Message"].Value=@"Please enter Transaction No";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Please enter Transaction No"";");
return;
base.WriteDebugInfo(@"return;");
}
if((ISpace["M_RandDTransactionDate"].Value == null))
{
base.WriteDebugInfo(@"if((ISpace[""M_RandDTransactionDate""].Value == null))");
ISpace["Message"].Value=@"Please Enter Transaction Date";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Please Enter Transaction Date"";");
return;
base.WriteDebugInfo(@"return;");
...
{
base.WriteDebugInfo(@"if(ISpace[""M_SaveDomainData""].Value==1)");
base.WriteDebugInfo(@"exec SendApproveEmailForTS '#MF_T1_TravelAdvanceID'");

var querySource6c18b6b2610028b940e21f6cd380da57 =GetQueryExpressionDataSource("6c18b6b2-6100-28b9-40e2-1f6cd380da57");
Dictionary<short,object> result6c18b6b2610028b940e21f6cd380da57=iSpace.ExecuteQuery(querySource6c18b6b2610028b940e21f6cd380da57,@"execSendApproveEmailForTS '" + ISpace["MF_T1_TravelAdvanceID"].Value + @"'",false);

base.WriteDebugInfo(@"var querySource6c18b6b2610028b940e21f6cd380da57 =GetQueryExpressionDataSource(""6c18b6b2-6100-28b9-40e2-1f6cd380da57"");Dictionary<short,object> result6c18b6b2610028b940e21f6cd380da57=iSpace.ExecuteQuery(querySource6c18b6b2610028b940e21f6cd380da57,@""execSendApproveEmailForTS '"" + ISpace[""MF_T1_TravelAdvanceID""].Value + @""'"",false);");
base.WriteDebugInfo(@"");

if((result6c18b6b2610028b940e21f6cd380da57!=null) && (result6c18b6b2610028b940e21f6cd380da57.Count!=0))
{
if(result6c18b6b2610028b940e21f6cd380da57.ContainsKey(0))
ISpace["A"].Value = result6c18b6b2610028b940e21f6cd380da57[0];
}
else{
ISpace["A"].Value = null;
}
...
using System.Linq;using System.Data;
using System.Runtime.CompilerServices;
public class ISpace0d7fa7ef8c7066b3f1721782236c8888 : VirtualForm
{
IISpace iSpace = new ISpace();
AcDataISpace0d7fa7ef8c7066b3f1721782236c8888 acdataIspace0d7fa7ef8c7066b3f1721782236c8888=new AcDataISpace0d7fa7ef8c7066b3f1721782236c8888();
private void SubscribeFormEvents_root(ref Dictionary<string, ServiceElementData> ISpace)
{
try
{
...
List<Triplet<string, short, short?>> resultF6CCD46BA27D469EB390A56BFBF805A6=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("F6CCD46B-A27D-469E-B390-A56BFBF805A6");
iSpace.SetGridData(result800FCB85CC5F45509D3F5D7AE4650DF2,resultF6CCD46BA27D469EB390A56BFBF805A6,"MG_RemarksDetails",ref ISpace);
iSpace.UpdateGridBindDetails("MG_RemarksDetails",resultF6CCD46BA27D469EB390A56BFBF805A6);
}
if(1==1)
...
List<Triplet<string, short, short?>> result33B5DB3CC03544548035C74029C72FC1=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("33B5DB3C-C035-4454-8035-C74029C72FC1");
iSpace.SetGridData(result10050FA13EE9447A84B73196AC6C3700,result33B5DB3CC03544548035C74029C72FC1,"MG_CommitmentDetails",ref ISpace);
iSpace.UpdateGridBindDetails("MG_CommitmentDetails",result33B5DB3CC03544548035C74029C72FC1);
}
catch(Exception ex)
...
List<Triplet<string, short, short?>> resultC5D359807A8E48F3A09BFFDE2E631008=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("C5D35980-7A8E-48F3-A09B-FFDE2E631008");
iSpace.SetGridData(result200CEBCC9949420EB45FF8454BAC10B5,resultC5D359807A8E48F3A09BFFDE2E631008,"TravelExpense",ref ISpace);
iSpace.UpdateGridBindDetails("TravelExpense",resultC5D359807A8E48F3A09BFFDE2E631008);
ISpace["Message"].Value=@"Data deleted successfully";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Data deleted successfully"";");
...
List<Triplet<string, short, short?>> result5FF52A9FC7A9483893076D31A18D61AB=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("5FF52A9F-C7A9-4838-9307-6D31A18D61AB");
iSpace.SetGridData(result47DEECA98E4E4FDE806BD716B4F25534,result5FF52A9FC7A9483893076D31A18D61AB,"TravelExpense",ref ISpace);
iSpace.UpdateGridBindDetails("TravelExpense",result5FF52A9FC7A9483893076D31A18D61AB);
}
else
...
List<Triplet<string, short, short?>> resultDA3CF2FEBFBD482BB0D7A4FADF01F4B2=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("DA3CF2FE-BFBD-482B-B0D7-A4FADF01F4B2");
iSpace.SetGridData(result68C5D0A58E3049AB91AD12CEEA91048F,resultDA3CF2FEBFBD482BB0D7A4FADF01F4B2,"TravelExpense",ref ISpace);
iSpace.UpdateGridBindDetails("TravelExpense",resultDA3CF2FEBFBD482BB0D7A4FADF01F4B2);
}
if(1==1)
...
List<Triplet<string, short, short?>> result64882DB7743847AABD1485B89B960F95=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("64882DB7-7438-47AA-BD14-85B89B960F95");
iSpace.SetGridData(result12B0DEF7CA444A9EA1D6DF341107FA9C,result64882DB7743847AABD1485B89B960F95,"OtherExpense",ref ISpace);
iSpace.UpdateGridBindDetails("OtherExpense",result64882DB7743847AABD1485B89B960F95);
}
else
...
List<Triplet<string, short, short?>> result6576B6646EA0465AB088222E2C22B535=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("6576B664-6EA0-465A-B088-222E2C22B535");
iSpace.SetGridData(resultD8D9A9765AAA4BD2B7D8AE2AA0ACF5BB,result6576B6646EA0465AB088222E2C22B535,"OtherExpense",ref ISpace);
iSpace.UpdateGridBindDetails("OtherExpense",result6576B6646EA0465AB088222E2C22B535);
}
if(1==1)
...
List<Triplet<string, short, short?>> resultE5D66127B8634FE5BB07A33C0F84EDE2=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("E5D66127-B863-4FE5-BB07-A33C0F84EDE2");
iSpace.SetGridData(resultDC54108308784D23B8BB9B0CE733EEDF,resultE5D66127B8634FE5BB07A33C0F84EDE2,"MF_FundAmount",ref ISpace);
iSpace.UpdateGridBindDetails("MF_FundAmount",resultE5D66127B8634FE5BB07A33C0F84EDE2);
ISpace["MF_FundDetailsId"].Value="";
base.WriteDebugInfo(@"ISpace[""MF_FundDetailsId""].Value="""";");
...
List<Triplet<string, short, short?>> resultE4242D902E8F4517812054465963606A=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("E4242D90-2E8F-4517-8120-54465963606A");
iSpace.SetGridData(result9B59C95F3EF44759B14AAA281DE48F47,resultE4242D902E8F4517812054465963606A,"OtherExpense",ref ISpace);
iSpace.UpdateGridBindDetails("OtherExpense",resultE4242D902E8F4517812054465963606A);
ISpace["Message"].Value=@"Data deleted successfully";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Data deleted successfully"";");
...
List<Triplet<string, short, short?>> result660A5B657E364792BC4AF2BBCA0468A9=acdataIspace0d7fa7ef8c7066b3f1721782236c8888.GetQueryExpressionBindings("660A5B65-7E36-4792-BC4A-F2BBCA0468A9");
iSpace.SetGridData(result4F4B72E220D7416689F90192E1123361,result660A5B657E364792BC4AF2BBCA0468A9,"MF_FundAmount",ref ISpace);
iSpace.UpdateGridBindDetails("MF_FundAmount",result660A5B657E364792BC4AF2BBCA0468A9);
object MG_Amount=iSpace.Sum("[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5]","MG_Amount","");
ISpace["M_SumOfFund"].Value=Convert.ChangeType(MG_Amount, MG_Amount.GetType());;
...
using System;
	...
	public partial class AcDataISpace8e7d1be4e590270502453782073ff3d2  : ExtensionActivityBase
	{		
...
using System;
	...
	public partial class AcDataISpace4a093f4ed96c27c087db6b043aed97dc  : ExtensionActivityBase
	{		
...
using System;
	...
	public partial class AcDataISpace7d9986908c450a1511721969d4aafed7  : ExtensionActivityBase
	{		
...
using System;
	...
	public partial class AcDataISpace0d7fa7ef8c7066b3f1721782236c8888  : ExtensionActivityBase
	{		
...
using System;
	...
	public partial class AcDataISpace9ec850958919e8ab735a7e71991b7d9d  : ExtensionActivityBase
	{		
