...
if (!iSpace.GetGridTableRows("MG_DcoumentDetails","Select * from Proof..[2624976A-0052-420C-8D20-F5C9444C7A48] WITH(NOLOCK) WHERE InstanceId='"+ISpace["InstanceId"].Value+@"'",ref ISpace))
{
...
base.WriteDebugInfo(@"if (!iSpace.GetGridTableRows(""MG_DcoumentDetails"",""Select * from Proof..[2624976A-0052-420C-8D20-F5C9444C7A48] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace))
{
    iSpace.GetLoopExpressionData(""MG_DcoumentDetails"",ref ISpace);
}
...
if (!iSpace.GetGridTableRows("M_FundAmount","Select * from Proof..[1234ab8a-bdd0-8930-2afd-ae17d0438c29] WITH(NOLOCK) WHERE InstanceId='"+ISpace["InstanceId"].Value+@"'",ref ISpace))
{
...
base.WriteDebugInfo(@"if (!iSpace.GetGridTableRows(""M_FundAmount"",""Select * from Proof..[1234ab8a-bdd0-8930-2afd-ae17d0438c29] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace))
{
    iSpace.GetLoopExpressionData(""M_FundAmount"",ref ISpace);
}
...
if (!iSpace.GetGridTableRows("MF_FundAmount","Select * from Proof..[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5] WITH(NOLOCK) WHERE InstanceId='"+ISpace["InstanceId"].Value+@"'",ref ISpace))
{
...
base.WriteDebugInfo(@"if (!iSpace.GetGridTableRows(""MF_FundAmount"",""Select * from Proof..[0BFAF73B-02D4-4680-B1C9-625AAFB02DB5] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace))
{
    iSpace.GetLoopExpressionData(""MF_FundAmount"",ref ISpace);
}
