    ...
    {		
       ...
       // {
		...
		private List<Triplet<string, string, string>> ComboDataSource = new List<Triplet<string, string, string>>
		{
			     ...
			     new Triplet<string, string, string>("M_Classification","3A103712-5244-4427-B2B6-1C4E046FD337",
												     @"exec LoadPurchaseItemCombo"),
			
						
			
			     new Triplet<string, string, string>("M_ReimbursementType","3A103712-5244-4427-B2B6-1C4E046FD337",
												     @"EXEC GetReimbursementType"),
			
						
			
			     new Triplet<string, string, string>("MG_P3_BudgetHeadId","9ADED37B-CD11-426B-AF16-DEAC75685EF5",
												     @"exec SP_GetDistrubitionDetails 5,'@MG_P3_PackageProcessMapId','@MG_P3_FundTypeId','','','','','@MG_P3_ProjectDetailsId'"),
			
						
			
			     new Triplet<string, string, string>("MFG_P3_BudgetHeadId","9ADED37B-CD11-426B-AF16-DEAC75685EF5",
												     @"exec SP_GetDistrubitionDetails 5,'@M_PackageProcessMapId','@MFG_P3_FundTypeId','','','','','@MFG_P3_ProjectDetailsId'"),
			
						
			
			     new Triplet<string, string, string>("MG_P3_ProjectDetailsId","3A103712-5244-4427-B2B6-1C4E046FD337",
												     @"EXEC Projects..GetProjectExtensionDetails 1,'@MG_P3_EmployeeBaicInfoId'"),
			
						
			
			     new Triplet<string, string, string>("MFG_P3_ProjectDetailsId","3A103712-5244-4427-B2B6-1C4E046FD337",
												     @"EXEC Projects..GetProjectExtensionDetails 1,'@UC_EmployeeBaicInfoId'"),
			
						
			
			     new Triplet<string, string, string>("MFG_P3_FundTypeId","9ADED37B-CD11-426B-AF16-DEAC75685EF5",
												     @"exec SP_GetDistrubitionDetails 4,'@M_PackageProcessMapId','',''"),
			
						
			
			     new Triplet<string, string, string>("M_SubClassication","3A103712-5244-4427-B2B6-1C4E046FD337",
			     ...
			     new Triplet<string, string, string>("MG_P3_FundTypeId","9ADED37B-CD11-426B-AF16-DEAC75685EF5",
												     @"exec SP_GetDistrubitionDetails 4,'@MG_P3_PackageProcessMapId','',''"),
			
						
			
			     new Triplet<string, string, string>("M_MoveTo","9ADED37B-CD11-426B-AF16-DEAC75685EF5",
     ...
     /// <summary>
            ...
            try
            {
                ...
                switch(formId)
                {
                                      ...
                                      case "93D6004F-3BCB-4A62-A41B-473BC5A0F0ED":
                    {
                                     ...
                                     fInsertQuery=@"IF NOT EXISTS(SELECT 1 FROM [93D6004F-3BCB-4A62-A41B-473BC5A0F0ED] WHERE InstanceId='{0}') BEGIN INSERT INTO [93D6004F-3BCB-4A62-A41B-473BC5A0F0ED](ProcessActivityMapId,FormId,M_SaveDomainData,M_Gridcount,IN_Priority,M_InitiatorUserMapId,UC_DOB,growid,MF_P1_Remarks,RedirectUrl,M_Stage,MF_P1_EmployeeBasicInfoId,UC_DOJ,M_ReimbursementId,IN_SLA,MF_E1_EmployeeBasicInfoId,UC_DOR,UC_EmployeeId,IN_InstanceName,MF_P1_ApplicationStatus,M_PackageProcessMapId,UC_EmailId,M_ReimbursementType,MF_ProjectNo,M_Classification,M_SubClassication,M_MoveTo,MF_P1_Initiatedon,MF_P1_UpdatedOn,Thumbnail,KeyContext,UC_Name,MF_P1_InitatedBy,M_MoveToValue,M_NextStage,M_Status,SetDestinationTo,AssignToUser,M_ErrMsg,AssignToRole,MF_P1_UpdatedBy,M_InstanceId,MF_P1_ReimbursementId,Subject,M_DestinationActivityId,ExecutionStatus,ExecutionMessage,UC_PhoneNumber,CancelRedirectUrl,DisplayContext,UC_Designation,UC_Paylevel,M_SourceActivityMapId,UC_Department,ExecuteCommand,UC_Grade,UC_EmployeeBaicInfoId,M_IsSourceStep,IN_Status,IN_Category,M_UpdateCount,M_IsflowReturned,M_IsCancelReject,M_RequestId,M_ErrId,M_RemarksMandatory,SLATime,MF_P1_TotalAmount,M_FieldMandatory,InstanceId)
							VALUES( {3}) END ELSE BEGIN UPDATE [93D6004F-3BCB-4A62-A41B-473BC5A0F0ED]SET {4}WHERE InstanceId='{0}'END ";

                                     colList=@"ProcessActivityMapId,FormId,M_SaveDomainData,M_Gridcount,IN_Priority,M_InitiatorUserMapId,UC_DOB,growid,MF_P1_Remarks,RedirectUrl,M_Stage,MF_P1_EmployeeBasicInfoId,UC_DOJ,M_ReimbursementId,IN_SLA,MF_E1_EmployeeBasicInfoId,UC_DOR,UC_EmployeeId,IN_InstanceName,MF_P1_ApplicationStatus,M_PackageProcessMapId,UC_EmailId,M_ReimbursementType,MF_ProjectNo,M_Classification,M_SubClassication,M_MoveTo,MF_P1_Initiatedon,MF_P1_UpdatedOn,Thumbnail,KeyContext,UC_Name,MF_P1_InitatedBy,M_MoveToValue,M_NextStage,M_Status,SetDestinationTo,AssignToUser,M_ErrMsg,AssignToRole,MF_P1_UpdatedBy,M_InstanceId,MF_P1_ReimbursementId,Subject,M_DestinationActivityId,ExecutionStatus,ExecutionMessage,UC_PhoneNumber,CancelRedirectUrl,DisplayContext,UC_Designation,UC_Paylevel,M_SourceActivityMapId,UC_Department,ExecuteCommand,UC_Grade,UC_EmployeeBaicInfoId,M_IsSourceStep,IN_Status,IN_Category,M_UpdateCount,M_IsflowReturned,M_IsCancelReject,M_RequestId,M_ErrId,M_RemarksMandatory,SLATime,MF_P1_TotalAmount,M_FieldMandatory,InstanceId";
            ...
            string gridId,long usermapid,string formJsonData)
      {
		...
		DECLARE  @TBL_93570AD2BC614B0CAE1C2A20265D17E7 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [M_DocumentDetailsId] VARCHAR(MAX)	, [M_DocumentName] VARCHAR(MAX)	, [M_UploadDcoument] VARCHAR(36)){0}INSERT INTO [93570AD2-BC61-4B0C-AE1C-2A20265D17E7](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,M_DocumentDetailsId,M_DocumentName,M_UploadDcoument)
							...
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId  WHERE DT.RowId IS NULL;UPDATE  DT SET ProcessActivityMapId=TDT.ProcessActivityMapId,Sequence=TDT.Sequence,M_DocumentDetailsId=TDT.M_DocumentDetailsId,M_DocumentName=TDT.M_DocumentName,M_UploadDcoument=TDT.M_UploadDcoument FROM @TBL_93570AD2BC614B0CAE1C2A20265D17E7 TDT
							JOIN [93570AD2-BC61-4B0C-AE1C-2A20265D17E7] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId ";
		...
		DECLARE  @TBL_B3C42BFD4F714A59BC58E5B5C95B481C AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_Commitment] DECIMAL(18,2)	, [MG_YetToReceive] DECIMAL(18,2)	, [MG_ReceivedAmount] DECIMAL(18,2)	, [MG_SanctionedAmount] DECIMAL(18,2)	, [MG_Spent] DECIMAL(18,2)	, [MG_BudgetName] VARCHAR(MAX)	, [MG_Balance] DECIMAL(18,2)){0}INSERT INTO [B3C42BFD-4F71-4A59-BC58-E5B5C95B481C](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_Commitment,MG_YetToReceive,MG_ReceivedAmount,MG_SanctionedAmount,MG_Spent,MG_BudgetName,MG_Balance)
							SELECT TDT.InstanceId,TDT.ProcessActivityMapId,TDT.GridId,TDT.RowId,TDT.Sequence,TDT.MG_Commitment,TDT.MG_YetToReceive,TDT.MG_ReceivedAmount,TDT.MG_SanctionedAmount,TDT.MG_Spent,TDT.MG_BudgetName,TDT.MG_Balance FROM @TBL_B3C42BFD4F714A59BC58E5B5C95B481C TDT
							LEFT JOIN [B3C42BFD-4F71-4A59-BC58-E5B5C95B481C] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId  WHERE DT.RowId IS NULL;UPDATE  DT SET ProcessActivityMapId=TDT.ProcessActivityMapId,Sequence=TDT.Sequence,MG_Commitment=TDT.MG_Commitment,MG_YetToReceive=TDT.MG_YetToReceive,MG_ReceivedAmount=TDT.MG_ReceivedAmount,MG_SanctionedAmount=TDT.MG_SanctionedAmount,MG_Spent=TDT.MG_Spent,MG_BudgetName=TDT.MG_BudgetName,MG_Balance=TDT.MG_Balance FROM @TBL_B3C42BFD4F714A59BC58E5B5C95B481C TDT
							JOIN [B3C42BFD-4F71-4A59-BC58-E5B5C95B481C] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId ";

                                     colList=@"InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_Commitment,MG_YetToReceive,MG_ReceivedAmount,MG_SanctionedAmount,MG_Spent,MG_BudgetName,MG_Balance";

                                     tempInsertQuery=@"INSERT INTO @TBL_B3C42BFD4F714A59BC58E5B5C95B481C(InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_Commitment,MG_YetToReceive,MG_ReceivedAmount,MG_SanctionedAmount,MG_Spent,MG_BudgetName,MG_Balance)VALUES({0});";
		...
		DECLARE  @TBL_B49EFF11DEBD4F34BEC57C607851D347 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [DateOfRemarks] DATETIME	, [RemarksId] VARCHAR(MAX)	, [ActivityName] VARCHAR(MAX)	, [Remarks] VARCHAR(MAX)	, [UserName] VARCHAR(MAX)){0}INSERT INTO [B49EFF11-DEBD-4F34-BEC5-7C607851D347](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,DateOfRemarks,RemarksId,ActivityName,Remarks,UserName)
							SELECT TDT.InstanceId,TDT.ProcessActivityMapId,TDT.GridId,TDT.RowId,TDT.Sequence,TDT.DateOfRemarks,TDT.RemarksId,TDT.ActivityName,TDT.Remarks,TDT.UserName FROM @TBL_B49EFF11DEBD4F34BEC57C607851D347 TDT
							LEFT JOIN [B49EFF11-DEBD-4F34-BEC5-7C607851D347] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId  WHERE DT.RowId IS NULL;UPDATE  DT SET ProcessActivityMapId=TDT.ProcessActivityMapId,Sequence=TDT.Sequence,DateOfRemarks=TDT.DateOfRemarks,RemarksId=TDT.RemarksId,ActivityName=TDT.ActivityName,Remarks=TDT.Remarks,UserName=TDT.UserName FROM @TBL_B49EFF11DEBD4F34BEC57C607851D347 TDT
							JOIN [B49EFF11-DEBD-4F34-BEC5-7C607851D347] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId ";

                                     colList=@"InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,DateOfRemarks,RemarksId,ActivityName,Remarks,UserName";

                                     tempInsertQuery=@"INSERT INTO @TBL_B49EFF11DEBD4F34BEC57C607851D347(InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,DateOfRemarks,RemarksId,ActivityName,Remarks,UserName)VALUES({0});";
		...
		DECLARE  @TBL_1D198218D4AF4E099A9D119D03D0C3BA AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_P2_BillDate] DATETIME	, [MG_P2_ReimbursementDetailsId] VARCHAR(MAX)	, [MG_P2_ReimbursementId] VARCHAR(MAX)	, [MG_P2_ItemDescription] VARCHAR(MAX)	, [MG_P2_BillNo] VARCHAR(MAX)	, [MG_P2_BillDocument] INT	, [MG_P2_Amount] DECIMAL(18,2)){0}INSERT INTO [1D198218-D4AF-4E09-9A9D-119D03D0C3BA](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P2_BillDate,MG_P2_ReimbursementDetailsId,MG_P2_ReimbursementId,MG_P2_ItemDescription,MG_P2_BillNo,MG_P2_BillDocument,MG_P2_Amount)
							SELECT TDT.InstanceId,TDT.ProcessActivityMapId,TDT.GridId,TDT.RowId,TDT.Sequence,TDT.MG_P2_BillDate,TDT.MG_P2_ReimbursementDetailsId,TDT.MG_P2_ReimbursementId,TDT.MG_P2_ItemDescription,TDT.MG_P2_BillNo,TDT.MG_P2_BillDocument,TDT.MG_P2_Amount FROM @TBL_1D198218D4AF4E099A9D119D03D0C3BA TDT
							LEFT JOIN [1D198218-D4AF-4E09-9A9D-119D03D0C3BA] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId  WHERE DT.RowId IS NULL;UPDATE  DT SET ProcessActivityMapId=TDT.ProcessActivityMapId,Sequence=TDT.Sequence,MG_P2_BillDate=TDT.MG_P2_BillDate,MG_P2_ReimbursementDetailsId=TDT.MG_P2_ReimbursementDetailsId,MG_P2_ReimbursementId=TDT.MG_P2_ReimbursementId,MG_P2_ItemDescription=TDT.MG_P2_ItemDescription,MG_P2_BillNo=TDT.MG_P2_BillNo,MG_P2_BillDocument=TDT.MG_P2_BillDocument,MG_P2_Amount=TDT.MG_P2_Amount FROM @TBL_1D198218D4AF4E099A9D119D03D0C3BA TDT
							JOIN [1D198218-D4AF-4E09-9A9D-119D03D0C3BA] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId ";

                                     colList=@"InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P2_BillDate,MG_P2_ReimbursementDetailsId,MG_P2_ReimbursementId,MG_P2_ItemDescription,MG_P2_BillNo,MG_P2_BillDocument,MG_P2_Amount";

                                     tempInsertQuery=@"INSERT INTO @TBL_1D198218D4AF4E099A9D119D03D0C3BA(InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P2_BillDate,MG_P2_ReimbursementDetailsId,MG_P2_ReimbursementId,MG_P2_ItemDescription,MG_P2_BillNo,MG_P2_BillDocument,MG_P2_Amount)VALUES({0});";
		...
		DECLARE  @TBL_84AEB9E030094426AB92AAF06D2B42AF AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_P3_Amount] DECIMAL(18,2)	, [MG_P3_FundTypeId] VARCHAR(250)	, [MG_P3_BudgetHeadId] VARCHAR(250)	, [MG_P3_ProjectDetailsId] VARCHAR(250)	, [MG_P3_PackageProcessMapId] VARCHAR(MAX)	, [MG_P3_FundDetailsId] VARCHAR(MAX)	, [MG_P3_ReimbursementId] VARCHAR(MAX)	, [MG_P3_EmployeeBaicInfoId] VARCHAR(MAX)){0}INSERT INTO [84AEB9E0-3009-4426-AB92-AAF06D2B42AF](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P3_Amount,MG_P3_FundTypeId,MG_P3_BudgetHeadId,MG_P3_ProjectDetailsId,MG_P3_PackageProcessMapId,MG_P3_FundDetailsId,MG_P3_ReimbursementId,MG_P3_EmployeeBaicInfoId)
							SELECT TDT.InstanceId,TDT.ProcessActivityMapId,TDT.GridId,TDT.RowId,TDT.Sequence,TDT.MG_P3_Amount,TDT.MG_P3_FundTypeId,TDT.MG_P3_BudgetHeadId,TDT.MG_P3_ProjectDetailsId,TDT.MG_P3_PackageProcessMapId,TDT.MG_P3_FundDetailsId,TDT.MG_P3_ReimbursementId,TDT.MG_P3_EmployeeBaicInfoId FROM @TBL_84AEB9E030094426AB92AAF06D2B42AF TDT
							LEFT JOIN [84AEB9E0-3009-4426-AB92-AAF06D2B42AF] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId  WHERE DT.RowId IS NULL;UPDATE  DT SET ProcessActivityMapId=TDT.ProcessActivityMapId,Sequence=TDT.Sequence,MG_P3_Amount=TDT.MG_P3_Amount,MG_P3_FundTypeId=TDT.MG_P3_FundTypeId,MG_P3_BudgetHeadId=TDT.MG_P3_BudgetHeadId,MG_P3_ProjectDetailsId=TDT.MG_P3_ProjectDetailsId,MG_P3_PackageProcessMapId=TDT.MG_P3_PackageProcessMapId,MG_P3_FundDetailsId=TDT.MG_P3_FundDetailsId,MG_P3_ReimbursementId=TDT.MG_P3_ReimbursementId,MG_P3_EmployeeBaicInfoId=TDT.MG_P3_EmployeeBaicInfoId FROM @TBL_84AEB9E030094426AB92AAF06D2B42AF TDT
							JOIN [84AEB9E0-3009-4426-AB92-AAF06D2B42AF] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId AND TDT.InstanceId=DT.InstanceId ";

                                     colList=@"InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P3_Amount,MG_P3_FundTypeId,MG_P3_BudgetHeadId,MG_P3_ProjectDetailsId,MG_P3_PackageProcessMapId,MG_P3_FundDetailsId,MG_P3_ReimbursementId,MG_P3_EmployeeBaicInfoId";

                                     tempInsertQuery=@"INSERT INTO @TBL_84AEB9E030094426AB92AAF06D2B42AF(InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P3_Amount,MG_P3_FundTypeId,MG_P3_BudgetHeadId,MG_P3_ProjectDetailsId,MG_P3_PackageProcessMapId,MG_P3_FundDetailsId,MG_P3_ReimbursementId,MG_P3_EmployeeBaicInfoId)VALUES({0});";
      ...
      public override string GetGridLoopQuery(string gridId,string gridName,ref Dictionary<string,ServiceElementData> gridData)
		...
		DECLARE  @TBL_93570AD2BC614B0CAE1C2A20265D17E7 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [M_DocumentDetailsId] VARCHAR(MAX)	, [M_DocumentName] VARCHAR(MAX)	, [M_UploadDcoument] VARCHAR(36)){0}INSERT INTO [93570AD2-BC61-4B0C-AE1C-2A20265D17E7](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,M_DocumentDetailsId,M_DocumentName,M_UploadDcoument)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,M_DocumentDetailsId#9,M_DocumentName#9,M_UploadDcoument#1";
		...
		DECLARE  @TBL_B3C42BFD4F714A59BC58E5B5C95B481C AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_Commitment] DECIMAL(18,2)	, [MG_YetToReceive] DECIMAL(18,2)	, [MG_ReceivedAmount] DECIMAL(18,2)	, [MG_SanctionedAmount] DECIMAL(18,2)	, [MG_Spent] DECIMAL(18,2)	, [MG_BudgetName] VARCHAR(MAX)	, [MG_Balance] DECIMAL(18,2)){0}INSERT INTO [B3C42BFD-4F71-4A59-BC58-E5B5C95B481C](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_Commitment,MG_YetToReceive,MG_ReceivedAmount,MG_SanctionedAmount,MG_Spent,MG_BudgetName,MG_Balance)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,MG_Commitment#3,MG_YetToReceive#3,MG_ReceivedAmount#3,MG_SanctionedAmount#3,MG_Spent#3,MG_BudgetName#9,MG_Balance#3";
		...
		DECLARE  @TBL_B49EFF11DEBD4F34BEC57C607851D347 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [DateOfRemarks] DATETIME	, [RemarksId] VARCHAR(MAX)	, [ActivityName] VARCHAR(MAX)	, [Remarks] VARCHAR(MAX)	, [UserName] VARCHAR(MAX)){0}INSERT INTO [B49EFF11-DEBD-4F34-BEC5-7C607851D347](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,DateOfRemarks,RemarksId,ActivityName,Remarks,UserName)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,DateOfRemarks#8,RemarksId#9,ActivityName#9,Remarks#9,UserName#9";
		...
		DECLARE  @TBL_1D198218D4AF4E099A9D119D03D0C3BA AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_P2_BillDate] DATETIME	, [MG_P2_ReimbursementDetailsId] VARCHAR(MAX)	, [MG_P2_ReimbursementId] VARCHAR(MAX)	, [MG_P2_ItemDescription] VARCHAR(MAX)	, [MG_P2_BillNo] VARCHAR(MAX)	, [MG_P2_BillDocument] INT	, [MG_P2_Amount] DECIMAL(18,2)){0}INSERT INTO [1D198218-D4AF-4E09-9A9D-119D03D0C3BA](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P2_BillDate,MG_P2_ReimbursementDetailsId,MG_P2_ReimbursementId,MG_P2_ItemDescription,MG_P2_BillNo,MG_P2_BillDocument,MG_P2_Amount)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,MG_P2_BillDate#8,MG_P2_ReimbursementDetailsId#9,MG_P2_ReimbursementId#9,MG_P2_ItemDescription#9,MG_P2_BillNo#9,MG_P2_BillDocument#5,MG_P2_Amount#3";
		...
		DECLARE  @TBL_84AEB9E030094426AB92AAF06D2B42AF AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_P3_Amount] DECIMAL(18,2)	, [MG_P3_FundTypeId] VARCHAR(250)	, [MG_P3_BudgetHeadId] VARCHAR(250)	, [MG_P3_ProjectDetailsId] VARCHAR(250)	, [MG_P3_PackageProcessMapId] VARCHAR(MAX)	, [MG_P3_FundDetailsId] VARCHAR(MAX)	, [MG_P3_ReimbursementId] VARCHAR(MAX)	, [MG_P3_EmployeeBaicInfoId] VARCHAR(MAX)){0}INSERT INTO [84AEB9E0-3009-4426-AB92-AAF06D2B42AF](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_P3_Amount,MG_P3_FundTypeId,MG_P3_BudgetHeadId,MG_P3_ProjectDetailsId,MG_P3_PackageProcessMapId,MG_P3_FundDetailsId,MG_P3_ReimbursementId,MG_P3_EmployeeBaicInfoId)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,MG_P3_Amount#3,MG_P3_FundTypeId#9,MG_P3_BudgetHeadId#9,MG_P3_ProjectDetailsId#9,MG_P3_PackageProcessMapId#9,MG_P3_FundDetailsId#9,MG_P3_ReimbursementId#9,MG_P3_EmployeeBaicInfoId#9";
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("ReimbursementBillDetails","1D198218-D4AF-4E09-9A9D-119D03D0C3BA",_objectFactory.GetGridRPP("ReimbursementBillDetails"),_elementBase.GetGridLoopQuery("1D198218-D4AF-4E09-9A9D-119D03D0C3BA","ReimbursementBillDetails",ref ISpace), ref ISpace);
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("ReimbursementFundDetails","84AEB9E0-3009-4426-AB92-AAF06D2B42AF",_objectFactory.GetGridRPP("ReimbursementFundDetails"),_elementBase.GetGridLoopQuery("84AEB9E0-3009-4426-AB92-AAF06D2B42AF","ReimbursementFundDetails",ref ISpace), ref ISpace);
...
iSpace.GetGridTableRows("ReimbursementFundDetails","Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='"+ISpace["InstanceId"].Value+@"'",ref ISpace);

 var grid = ISpace["ReimbursementFundDetails"];

 foreach(var gridrow in grid.Child) 
{

var MG_P3_PackageProcessMapIdIndexSO= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_PackageProcessMapId");
var M_PackageProcessMapIdIndexlX= iSpace.GetGridColumnIndex(gridrow.Child, "M_PackageProcessMapId");
gridrow.Child[MG_P3_PackageProcessMapIdIndexSO].Value=gridrow.Child[M_PackageProcessMapIdIndexlX].Value;
base.WriteDebugInfo(@"var MG_P3_PackageProcessMapIdIndexSO= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_PackageProcessMapId"");
var M_PackageProcessMapIdIndexlX= iSpace.GetGridColumnIndex(gridrow.Child, ""M_PackageProcessMapId"");
gridrow.Child[MG_P3_PackageProcessMapIdIndexSO].Value=gridrow.Child[M_PackageProcessMapIdIndexlX].Value;");
var MG_P3_EmployeeBaicInfoIdIndexBZ= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_EmployeeBaicInfoId");
var UC_EmployeeBaicInfoIdIndexQS= iSpace.GetGridColumnIndex(gridrow.Child, "UC_EmployeeBaicInfoId");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexBZ].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexQS].Value;
base.WriteDebugInfo(@"var MG_P3_EmployeeBaicInfoIdIndexBZ= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_EmployeeBaicInfoId"");
var UC_EmployeeBaicInfoIdIndexQS= iSpace.GetGridColumnIndex(gridrow.Child, ""UC_EmployeeBaicInfoId"");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexBZ].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexQS].Value;");
}
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""ReimbursementFundDetails"",""Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
iSpace.GetGridTableRows("MG_DcoumentDetails","Select * from Proof..[93570AD2-BC61-4B0C-AE1C-2A20265D17E7] WITH(NOLOCK) WHERE InstanceId='"+ISpace["InstanceId"].Value+@"'",ref ISpace);

 var grid = ISpace["MG_DcoumentDetails"];

 foreach(var gridrow in grid.Child) 
{

var M_DocumentNameIndexmw= iSpace.GetGridColumnIndex(gridrow.Child, "M_DocumentName");
if(
gridrow.Child[M_DocumentNameIndexmw].Value=="")
{
base.WriteDebugInfo(@"var M_DocumentNameIndexmw= iSpace.GetGridColumnIndex(gridrow.Child, ""M_DocumentName"");
if(
gridrow.Child[M_DocumentNameIndexmw].Value=="""")");
...
var M_UploadDcoumentIndexJk= iSpace.GetGridColumnIndex(gridrow.Child, "M_UploadDcoument");
if(
IsNullOrEmpty(gridrow.Child[M_UploadDcoumentIndexJk].Value))
{
base.WriteDebugInfo(@"var M_UploadDcoumentIndexJk= iSpace.GetGridColumnIndex(gridrow.Child, ""M_UploadDcoument"");
if(
IsNullOrEmpty(gridrow.Child[M_UploadDcoumentIndexJk].Value))");
...
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""MG_DcoumentDetails"",""Select * from Proof..[93570AD2-BC61-4B0C-AE1C-2A20265D17E7] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("MG_CommitmentDetails","B3C42BFD-4F71-4A59-BC58-E5B5C95B481C",_objectFactory.GetGridRPP("MG_CommitmentDetails"),_elementBase.GetGridLoopQuery("B3C42BFD-4F71-4A59-BC58-E5B5C95B481C","MG_CommitmentDetails",ref ISpace), ref ISpace);
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("MG_RemarksDetails","B49EFF11-DEBD-4F34-BEC5-7C607851D347",_objectFactory.GetGridRPP("MG_RemarksDetails"),_elementBase.GetGridLoopQuery("B49EFF11-DEBD-4F34-BEC5-7C607851D347","MG_RemarksDetails",ref ISpace), ref ISpace);
...
var MG_P3_PackageProcessMapIdIndexyN= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_PackageProcessMapId");
var M_PackageProcessMapIdIndexUk= iSpace.GetGridColumnIndex(gridrow.Child, "M_PackageProcessMapId");
gridrow.Child[MG_P3_PackageProcessMapIdIndexyN].Value=gridrow.Child[M_PackageProcessMapIdIndexUk].Value;
base.WriteDebugInfo(@"var MG_P3_PackageProcessMapIdIndexyN= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_PackageProcessMapId"");
var M_PackageProcessMapIdIndexUk= iSpace.GetGridColumnIndex(gridrow.Child, ""M_PackageProcessMapId"");
gridrow.Child[MG_P3_PackageProcessMapIdIndexyN].Value=gridrow.Child[M_PackageProcessMapIdIndexUk].Value;");
var MG_P3_EmployeeBaicInfoIdIndex9v= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_EmployeeBaicInfoId");
var UC_EmployeeBaicInfoIdIndexmU= iSpace.GetGridColumnIndex(gridrow.Child, "UC_EmployeeBaicInfoId");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndex9v].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexmU].Value;
base.WriteDebugInfo(@"var MG_P3_EmployeeBaicInfoIdIndex9v= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_EmployeeBaicInfoId"");
var UC_EmployeeBaicInfoIdIndexmU= iSpace.GetGridColumnIndex(gridrow.Child, ""UC_EmployeeBaicInfoId"");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndex9v].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexmU].Value;");
}
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""ReimbursementFundDetails"",""Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
var M_IsflowReturnedIndexYE= iSpace.GetGridColumnIndex(gridrow.Child, "M_IsflowReturned");
if(
gridrow.Child[M_IsflowReturnedIndexYE].Value==1)
{
base.WriteDebugInfo(@"var M_IsflowReturnedIndexYE= iSpace.GetGridColumnIndex(gridrow.Child, ""M_IsflowReturned"");
if(
gridrow.Child[M_IsflowReturnedIndexYE].Value==1)");
...
var MG_P3_PackageProcessMapIdIndexeN= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_PackageProcessMapId");
var M_PackageProcessMapIdIndexHS= iSpace.GetGridColumnIndex(gridrow.Child, "M_PackageProcessMapId");
gridrow.Child[MG_P3_PackageProcessMapIdIndexeN].Value=gridrow.Child[M_PackageProcessMapIdIndexHS].Value;
base.WriteDebugInfo(@"var MG_P3_PackageProcessMapIdIndexeN= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_PackageProcessMapId"");
var M_PackageProcessMapIdIndexHS= iSpace.GetGridColumnIndex(gridrow.Child, ""M_PackageProcessMapId"");
gridrow.Child[MG_P3_PackageProcessMapIdIndexeN].Value=gridrow.Child[M_PackageProcessMapIdIndexHS].Value;");
var MG_P3_EmployeeBaicInfoIdIndexkz= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_EmployeeBaicInfoId");
var UC_EmployeeBaicInfoIdIndex9f= iSpace.GetGridColumnIndex(gridrow.Child, "UC_EmployeeBaicInfoId");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexkz].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndex9f].Value;
base.WriteDebugInfo(@"var MG_P3_EmployeeBaicInfoIdIndexkz= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_EmployeeBaicInfoId"");
var UC_EmployeeBaicInfoIdIndex9f= iSpace.GetGridColumnIndex(gridrow.Child, ""UC_EmployeeBaicInfoId"");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexkz].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndex9f].Value;");
}
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""ReimbursementFundDetails"",""Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
var M_IsflowReturnedIndex5x= iSpace.GetGridColumnIndex(gridrow.Child, "M_IsflowReturned");
if(
gridrow.Child[M_IsflowReturnedIndex5x].Value==1)
{
base.WriteDebugInfo(@"var M_IsflowReturnedIndex5x= iSpace.GetGridColumnIndex(gridrow.Child, ""M_IsflowReturned"");
if(
gridrow.Child[M_IsflowReturnedIndex5x].Value==1)");
base.WriteDebugInfo(@"EXEC [UpsertProjectBudgetDetails] 6,'#MG_P3_ProjectDetailsId','','#MG_P3_Amount','#MG_P3_BudgetHeadId',1,'#MG_P3_FundTypeId'");
...
var MG_P3_PackageProcessMapIdIndexmB= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_PackageProcessMapId");
var M_PackageProcessMapIdIndexKq= iSpace.GetGridColumnIndex(gridrow.Child, "M_PackageProcessMapId");
gridrow.Child[MG_P3_PackageProcessMapIdIndexmB].Value=gridrow.Child[M_PackageProcessMapIdIndexKq].Value;
base.WriteDebugInfo(@"var MG_P3_PackageProcessMapIdIndexmB= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_PackageProcessMapId"");
var M_PackageProcessMapIdIndexKq= iSpace.GetGridColumnIndex(gridrow.Child, ""M_PackageProcessMapId"");
gridrow.Child[MG_P3_PackageProcessMapIdIndexmB].Value=gridrow.Child[M_PackageProcessMapIdIndexKq].Value;");
var MG_P3_EmployeeBaicInfoIdIndexws= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_EmployeeBaicInfoId");
var UC_EmployeeBaicInfoIdIndexw1= iSpace.GetGridColumnIndex(gridrow.Child, "UC_EmployeeBaicInfoId");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexws].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexw1].Value;
base.WriteDebugInfo(@"var MG_P3_EmployeeBaicInfoIdIndexws= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_EmployeeBaicInfoId"");
var UC_EmployeeBaicInfoIdIndexw1= iSpace.GetGridColumnIndex(gridrow.Child, ""UC_EmployeeBaicInfoId"");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexws].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexw1].Value;");
}
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""ReimbursementFundDetails"",""Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
var M_IsflowReturnedIndexMW= iSpace.GetGridColumnIndex(gridrow.Child, "M_IsflowReturned");
if(
gridrow.Child[M_IsflowReturnedIndexMW].Value==1)
{
base.WriteDebugInfo(@"var M_IsflowReturnedIndexMW= iSpace.GetGridColumnIndex(gridrow.Child, ""M_IsflowReturned"");
if(
gridrow.Child[M_IsflowReturnedIndexMW].Value==1)");
base.WriteDebugInfo(@"EXEC [UpsertProjectBudgetDetails] 6,'#MG_P3_ProjectDetailsId','','#MG_P3_Amount','#MG_P3_BudgetHeadId',1,'#MG_P3_FundTypeId'");
...
var MG_P3_PackageProcessMapIdIndexEw= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_PackageProcessMapId");
var M_PackageProcessMapIdIndexJi= iSpace.GetGridColumnIndex(gridrow.Child, "M_PackageProcessMapId");
gridrow.Child[MG_P3_PackageProcessMapIdIndexEw].Value=gridrow.Child[M_PackageProcessMapIdIndexJi].Value;
base.WriteDebugInfo(@"var MG_P3_PackageProcessMapIdIndexEw= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_PackageProcessMapId"");
var M_PackageProcessMapIdIndexJi= iSpace.GetGridColumnIndex(gridrow.Child, ""M_PackageProcessMapId"");
gridrow.Child[MG_P3_PackageProcessMapIdIndexEw].Value=gridrow.Child[M_PackageProcessMapIdIndexJi].Value;");
var MG_P3_EmployeeBaicInfoIdIndexlI= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_EmployeeBaicInfoId");
var UC_EmployeeBaicInfoIdIndexmC= iSpace.GetGridColumnIndex(gridrow.Child, "UC_EmployeeBaicInfoId");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexlI].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexmC].Value;
base.WriteDebugInfo(@"var MG_P3_EmployeeBaicInfoIdIndexlI= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_EmployeeBaicInfoId"");
var UC_EmployeeBaicInfoIdIndexmC= iSpace.GetGridColumnIndex(gridrow.Child, ""UC_EmployeeBaicInfoId"");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexlI].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexmC].Value;");
}
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""ReimbursementFundDetails"",""Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
var M_IsflowReturnedIndexsT= iSpace.GetGridColumnIndex(gridrow.Child, "M_IsflowReturned");
if(
gridrow.Child[M_IsflowReturnedIndexsT].Value==1)
{
base.WriteDebugInfo(@"var M_IsflowReturnedIndexsT= iSpace.GetGridColumnIndex(gridrow.Child, ""M_IsflowReturned"");
if(
gridrow.Child[M_IsflowReturnedIndexsT].Value==1)");
base.WriteDebugInfo(@"EXEC [UpsertProjectBudgetDetails] 6,'#MG_P3_ProjectDetailsId','','#MG_P3_Amount','#MG_P3_BudgetHeadId',1,'#MG_P3_FundTypeId'");
...
var M_SaveDomainDataIndexZ4= iSpace.GetGridColumnIndex(gridrow.Child, "M_SaveDomainData");
if(
gridrow.Child[M_SaveDomainDataIndexZ4].Value==1)
{
base.WriteDebugInfo(@"var M_SaveDomainDataIndexZ4= iSpace.GetGridColumnIndex(gridrow.Child, ""M_SaveDomainData"");
if(
gridrow.Child[M_SaveDomainDataIndexZ4].Value==1)");
...
var MG_P3_PackageProcessMapIdIndexEQ= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_PackageProcessMapId");
var M_PackageProcessMapIdIndexRF= iSpace.GetGridColumnIndex(gridrow.Child, "M_PackageProcessMapId");
gridrow.Child[MG_P3_PackageProcessMapIdIndexEQ].Value=gridrow.Child[M_PackageProcessMapIdIndexRF].Value;
base.WriteDebugInfo(@"var MG_P3_PackageProcessMapIdIndexEQ= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_PackageProcessMapId"");
var M_PackageProcessMapIdIndexRF= iSpace.GetGridColumnIndex(gridrow.Child, ""M_PackageProcessMapId"");
gridrow.Child[MG_P3_PackageProcessMapIdIndexEQ].Value=gridrow.Child[M_PackageProcessMapIdIndexRF].Value;");
var MG_P3_EmployeeBaicInfoIdIndexqG= iSpace.GetGridColumnIndex(gridrow.Child, "MG_P3_EmployeeBaicInfoId");
var UC_EmployeeBaicInfoIdIndexJI= iSpace.GetGridColumnIndex(gridrow.Child, "UC_EmployeeBaicInfoId");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexqG].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexJI].Value;
base.WriteDebugInfo(@"var MG_P3_EmployeeBaicInfoIdIndexqG= iSpace.GetGridColumnIndex(gridrow.Child, ""MG_P3_EmployeeBaicInfoId"");
var UC_EmployeeBaicInfoIdIndexJI= iSpace.GetGridColumnIndex(gridrow.Child, ""UC_EmployeeBaicInfoId"");
gridrow.Child[MG_P3_EmployeeBaicInfoIdIndexqG].Value=gridrow.Child[UC_EmployeeBaicInfoIdIndexJI].Value;");
}
base.WriteDebugInfo(@"iSpace.GetGridTableRows(""ReimbursementFundDetails"",""Select * from Proof..[84AEB9E0-3009-4426-AB92-AAF06D2B42AF] WITH(NOLOCK) WHERE InstanceId='""+ISpace[""InstanceId""].Value+@""'"",ref ISpace);
...
var M_DocumentNameIndexWo= iSpace.GetGridColumnIndex(gridrow.Child, "M_DocumentName");
if(
gridrow.Child[M_DocumentNameIndexWo].Value=="")
{
base.WriteDebugInfo(@"var M_DocumentNameIndexWo= iSpace.GetGridColumnIndex(gridrow.Child, ""M_DocumentName"");
if(
gridrow.Child[M_DocumentNameIndexWo].Value=="""")");
ISpace["Message"].Value=@"Document Name should be Mandatory";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Document Name should be Mandatory"";");
...
var M_UploadDcoumentIndex2R= iSpace.GetGridColumnIndex(gridrow.Child, "M_UploadDcoument");
if(
IsNullOrEmpty(gridrow.Child[M_UploadDcoumentIndex2R].Value))
{
base.WriteDebugInfo(@"var M_UploadDcoumentIndex2R= iSpace.GetGridColumnIndex(gridrow.Child, ""M_UploadDcoument"");
if(
IsNullOrEmpty(gridrow.Child[M_UploadDcoumentIndex2R].Value))");
ISpace["Message"].Value=@"Upload Document should be mandatory";
base.WriteDebugInfo(@"ISpace[""Message""].Value=@""Upload Document should be mandatory"";");
...
var M_IsCancelRejectIndexjC= iSpace.GetGridColumnIndex(gridrow.Child, "M_IsCancelReject");
if(
gridrow.Child[M_IsCancelRejectIndexjC].Value==1)
{
base.WriteDebugInfo(@"var M_IsCancelRejectIndexjC= iSpace.GetGridColumnIndex(gridrow.Child, ""M_IsCancelReject"");
if(
gridrow.Child[M_IsCancelRejectIndexjC].Value==1)");
base.WriteDebugInfo(@"EXEC [UpsertProjectBudgetDetails] 6,'#MG_P3_ProjectDetailsId','','#MG_P3_Amount','#MG_P3_BudgetHeadId',1,'#MG_P3_FundTypeId'");
