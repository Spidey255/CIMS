    ...
    {		
       ...
       // {
		...
		private List<Triplet<string, string, string>> ComboDataSource = new List<Triplet<string, string, string>>
		{
			     ...
			     new Triplet<string, string, string>("MF_ExpenseDetails_GridRows","062C4298-5FB2-4C83-877D-A1D5795686CF",
												     @"EXEC [dbo].[SP_GetAutoFormGridRows]"),
			
						
			
			     new Triplet<string, string, string>("MF_Budgetdetails_GridRows","062C4298-5FB2-4C83-877D-A1D5795686CF",
												     @"EXEC [dbo].[SP_GetAutoFormGridRows]"),
			
						
			
			     new Triplet<string, string, string>("MF_ReceiptsView_GridRows","062C4298-5FB2-4C83-877D-A1D5795686CF",
												     @"EXEC [dbo].[SP_GetAutoFormGridRows]"),
			
						
			
			     new Triplet<string, string, string>("MF_ProjectCommitments_GridRows","062C4298-5FB2-4C83-877D-A1D5795686CF",
												     @"EXEC [dbo].[SP_GetAutoFormGridRows]"),
     ...
     /// <summary>
      ...
      public override string GetGridLoopQuery(string gridId,string gridName,bool IsGridReset,ref Dictionary<string,ServiceElementData> gridData)
            ...
            try
            {
                ...
                switch (gridId)
                {
                                         ...
                                         case "D56A52C8-2D23-4F88-A6D2-148D57FAD218":
                    {
                                ...
                                deleteQuery="Delete FROM [D56A52C8-2D23-4F88-A6D2-148D57FAD218] WHERE InstanceId='{0}';";
		...
		DECLARE  @TBL_D56A52C82D234F88A6D2148D57FAD218 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT){0}INSERT INTO [D56A52C8-2D23-4F88-A6D2-148D57FAD218](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0";
                                              ...
                                              case "D20793F2-23FB-4CCE-AB6D-5D14FE42B1B2":
                    {
                                ...
                                //Delete Existing Records of InstanceId
                                deleteQuery="Delete FROM [D20793F2-23FB-4CCE-AB6D-5D14FE42B1B2] WHERE InstanceId='{0}';";
		...
		DECLARE  @TBL_D20793F223FB4CCEAB6D5D14FE42B1B2 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MGG_V1_BudgetHeadID] VARCHAR(MAX)	, [MGG_V1_ProjectDetailsID] VARCHAR(MAX)	, [MGG_V1_BudgetHead] VARCHAR(MAX)	, [MGG_V1_SanctionedAmount] DECIMAL(18,2)	, [MGG_V1_ReceivedAmount] DECIMAL(18,2)	, [MGG_V1_YettoReceive] DECIMAL(18,2)	, [MGG_V1_Spent] DECIMAL(18,2)	, [MGG_V1_Committment] DECIMAL(18,2)	, [MGG_V1_Balance] DECIMAL(18,2)){0}INSERT INTO [D20793F2-23FB-4CCE-AB6D-5D14FE42B1B2](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MGG_V1_BudgetHeadID,MGG_V1_ProjectDetailsID,MGG_V1_BudgetHead,MGG_V1_SanctionedAmount,MGG_V1_ReceivedAmount,MGG_V1_YettoReceive,MGG_V1_Spent,MGG_V1_Committment,MGG_V1_Balance)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,MGG_V1_BudgetHeadID#9,MGG_V1_ProjectDetailsID#9,MGG_V1_BudgetHead#9,MGG_V1_SanctionedAmount#3,MGG_V1_ReceivedAmount#3,MGG_V1_YettoReceive#3,MGG_V1_Spent#3,MGG_V1_Committment#3,MGG_V1_Balance#3";
                                              ...
                                              case "C5B61F31-1A40-4640-939A-14D8636A8493":
                    {
                                ...
                                //Delete Existing Records of InstanceId
                                deleteQuery="Delete FROM [C5B61F31-1A40-4640-939A-14D8636A8493] WHERE InstanceId='{0}';";
		...
		DECLARE  @TBL_C5B61F311A404640939A14D8636A8493 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MGG_P1_ReceiptsId] VARCHAR(MAX)	, [MGG_P1_ProjectDetailsId] VARCHAR(MAX)	, [MGG_P1_ReceiptAmount] DECIMAL(18,2)	, [MGG_P1_ReceiptDate] DATETIME	, [MGG_P1_TransferType] VARCHAR(MAX)	, [MGG_P1_TransferReferenceNumber] VARCHAR(MAX)	, [MGG_P1_TransferReferenceDate] DATETIME	, [MGG_P1_TransferReferenceBankId] VARCHAR(MAX)	, [MGG_P1_TransferReferenceBranch] VARCHAR(MAX)	, [MGG_P1_ReceiptNo] VARCHAR(MAX)){0}INSERT INTO [C5B61F31-1A40-4640-939A-14D8636A8493](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MGG_P1_ReceiptsId,MGG_P1_ProjectDetailsId,MGG_P1_ReceiptAmount,MGG_P1_ReceiptDate,MGG_P1_TransferType,MGG_P1_TransferReferenceNumber,MGG_P1_TransferReferenceDate,MGG_P1_TransferReferenceBankId,MGG_P1_TransferReferenceBranch,MGG_P1_ReceiptNo)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,MGG_P1_ReceiptsId#9,MGG_P1_ProjectDetailsId#9,MGG_P1_ReceiptAmount#3,MGG_P1_ReceiptDate#8,MGG_P1_TransferType#9,MGG_P1_TransferReferenceNumber#9,MGG_P1_TransferReferenceDate#8,MGG_P1_TransferReferenceBankId#9,MGG_P1_TransferReferenceBranch#9,MGG_P1_ReceiptNo#9";
                                              ...
                                              case "D8F430EF-D0A1-4887-B0CC-DB94A0BF0D93":
                    {
                                ...
                                //Delete Existing Records of InstanceId
                                deleteQuery="Delete FROM [D8F430EF-D0A1-4887-B0CC-DB94A0BF0D93] WHERE InstanceId='{0}';";
		...
		DECLARE  @TBL_D8F430EFD0A14887B0CCDB94A0BF0D93 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MGG_V1_ExpenseID] VARCHAR(MAX)	, [MGG_V1_PackageProcessMapID] VARCHAR(MAX)	, [MGG_V1_ExpenseDate] DATETIME	, [MGG_V1_AmountSpent] DECIMAL(18,2)	, [MGG_V1_ExpenseDescription] VARCHAR(MAX)){0}INSERT INTO [D8F430EF-D0A1-4887-B0CC-DB94A0BF0D93](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MGG_V1_ExpenseID,MGG_V1_PackageProcessMapID,MGG_V1_ExpenseDate,MGG_V1_AmountSpent,MGG_V1_ExpenseDescription)
                            ...
                            colListwithEDT=@"InstanceId#0,ProcessActivityMapId#0,GridId#0,RowId#0,Sequence#0,MGG_V1_ExpenseID#9,MGG_V1_PackageProcessMapID#9,MGG_V1_ExpenseDate#8,MGG_V1_AmountSpent#3,MGG_V1_ExpenseDescription#9";
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("ExpenseDetails","D56A52C8-2D23-4F88-A6D2-148D57FAD218",_objectFactory.GetGridRPP("ExpenseDetails"),_elementBase.GetGridLoopQuery("D56A52C8-2D23-4F88-A6D2-148D57FAD218","ExpenseDetails",true,ref ISpace), ref ISpace);
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("ReceiptsView","C5B61F31-1A40-4640-939A-14D8636A8493",_objectFactory.GetGridRPP("ReceiptsView"),_elementBase.GetGridLoopQuery("C5B61F31-1A40-4640-939A-14D8636A8493","ReceiptsView",true,ref ISpace), ref ISpace);
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("ProjectCommitments","D8F430EF-D0A1-4887-B0CC-DB94A0BF0D93",_objectFactory.GetGridRPP("ProjectCommitments"),_elementBase.GetGridLoopQuery("D8F430EF-D0A1-4887-B0CC-DB94A0BF0D93","ProjectCommitments",true,ref ISpace), ref ISpace);
...
if (_elementBase != null)  iSpace.SetLoopExpressionData("Budgetdetails","D20793F2-23FB-4CCE-AB6D-5D14FE42B1B2",_objectFactory.GetGridRPP("Budgetdetails"),_elementBase.GetGridLoopQuery("D20793F2-23FB-4CCE-AB6D-5D14FE42B1B2","Budgetdetails",true,ref ISpace), ref ISpace);
