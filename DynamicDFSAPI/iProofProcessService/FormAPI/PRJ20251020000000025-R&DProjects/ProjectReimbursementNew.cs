...
base.WriteDebugInfo(@"EXEC InnovaceNoCode..[FormSave_7580ABE2-1059-4AB0-AC76-04DE981561BA]   '@@gv_InstanceId','@@gv_ActivityMapId','36447555-6c49-45cd-8563-426f536ebf74','#MF_d1_ReimbursementId','#MF_d1_EmployeeBasicInfoId',#MF_d1_TotalAmount,'#MF_d1_Initiatedon','#MF_d1_InitatedBy','#MF_d1_ApplicationStatus',#MF_d1_ReimbursementType,#MF_d1_Classification,#MF_d1_SubClassification,'#MF_d1_UpdatedBy','#MF_d1_UpdatedOn'");

var querySource5C837D60C28D4224BAECAFC4E77AECAD =GetQueryExpressionDataSource("5C837D60-C28D-4224-BAEC-AFC4E77AECAD");
Dictionary<short,object> result5C837D60C28D4224BAECAFC4E77AECAD=iSpace.ExecuteQuery(querySource5C837D60C28D4224BAECAFC4E77AECAD,@"EXEC InnovaceNoCode..[FormSave_7580ABE2-1059-4AB0-AC76-04DE981561BA]   '" + ISpace["gv_instanceid"].Value + @"','" + ISpace["gv_activitymapid"].Value + @"','36447555-6c49-45cd-8563-426f536ebf74','" + ISpace["MF_d1_ReimbursementId"].Value + @"','" + ISpace["MF_d1_EmployeeBasicInfoId"].Value + @"'," + ISpace["MF_d1_TotalAmount"].Value + @",'" + ISpace["MF_d1_Initiatedon"].Value + @"','" + ISpace["MF_d1_InitatedBy"].Value + @"','" + ISpace["MF_d1_ApplicationStatus"].Value + @"'," + ISpace["MF_d1_ReimbursementType"].Value + @"," + ISpace["MF_d1_Classification"].Value + @"," + ISpace["MF_d1_SubClassification"].Value + @",'" + ISpace["MF_d1_UpdatedBy"].Value + @"','" + ISpace["MF_d1_UpdatedOn"].Value + @"'",false);
...
ISpace["ExecutionMessage"].Value = result4729BCA08B6D4424A3D94EB16A532C2B[0];
}
else{
ISpace["ExecutionMessage"].Value = null;
}
