...
iSpace.InsertGridBindDetails("MG_ReceiptDetails","11",querySource99d3e3ef818db2c5430f3c6fd63ed12c,"EXEC [GetReceiptExplorerDetails] 2,'" + ISpace["MF_ProjectRefNo"].Value + @"','" + ISpace["MF_Status"].Value + @"','" + ISpace["gv_userid"].Value + @"'",_objectFactory.GetGridRPP("MG_ReceiptDetails"));

base.WriteDebugInfo(@"var querySource99d3e3ef818db2c5430f3c6fd63ed12c =GetQueryExpressionDataSource(""99d3e3ef-818d-b2c5-430f-3c6fd63ed12c"");DataTable result99d3e3ef818db2c5430f3c6fd63ed12c=iSpace.SetGridDataSource(querySource99d3e3ef818db2c5430f3c6fd63ed12c, _objectFactory.GetGridRPP(""MG_ReceiptDetails""),@""EXEC [GetReceiptExplorerDetails] 2,'"" + ISpace[""MF_ProjectRefNo""].Value + @""','"" + ISpace[""MF_Status""].Value + @""','"" + ISpace[""gv_userid""].Value + @""'"");iSpace.InsertGridBindDetails(""MG_ReceiptDetails"",""11"",querySource99d3e3ef818db2c5430f3c6fd63ed12c,""EXEC [GetReceiptExplorerDetails] 2,'"" + ISpace[""MF_ProjectRefNo""].Value + @""','"" + ISpace[""MF_Status""].Value + @""','"" + ISpace[""gv_userid""].Value + @""'"",_objectFactory.GetGridRPP(""MG_ReceiptDetails""));");
base.WriteDebugInfo(@"");
...
iSpace.UpdateGridBindDetails("MG_ReceiptDetails",result18a694d4a66ab49beac600a4043f47e8);
}
}
catch(Exception ex)
{
