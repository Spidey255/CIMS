...
namespace CPS.Proof.DFSExtension
{
    internal  class ExternalQueryExecutorMsSql : MsSQLControllerBase, IExternalQueryController
    {
            ...
            string gridId,long usermapid,string formJsonData)
      {
		...
		DECLARE  @TBL_FC9B8D2E9EE3436FAF08A774AF04D678 AS TABLE(	  [InstanceId] VARCHAR(36)	, [ProcessActivityMapId] VARCHAR(36)	, [GridId] VARCHAR(36)	, [RowId] VARCHAR(36)	, [Sequence] INT	, [MG_d2_ExternalInstituteName] VARCHAR(50)	, [MG_d2_UpdatedBy] BIGINT	, [MG_d2_ExternalFacultyName] VARCHAR(50)	, [MG_d2_ProjectDetailsID] NVARCHAR(50)	, [MG_d2_ExternalEmailId] VARCHAR(50)	, [MG_d2_ExternalContactNo] VARCHAR(50)	, [MG_d2_DesignationID] NVARCHAR(50)	, [MG_d2_AdditionalID] NVARCHAR(50)	, [MG_d2_UpdatedOn] DATETIME	, [MG_d2_ExternalDesignation] VARCHAR(50)	, [MG_d2_AdditionalType] INT){0}INSERT INTO [FC9B8D2E-9EE3-436F-AF08-A774AF04D678](InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_d2_ExternalInstituteName,MG_d2_UpdatedBy,MG_d2_ExternalFacultyName,MG_d2_ProjectDetailsID,MG_d2_ExternalEmailId,MG_d2_ExternalContactNo,MG_d2_DesignationID,MG_d2_AdditionalID,MG_d2_UpdatedOn,MG_d2_ExternalDesignation,MG_d2_AdditionalType)
							SELECT TDT.InstanceId,TDT.ProcessActivityMapId,TDT.GridId,TDT.RowId,TDT.Sequence,TDT.MG_d2_ExternalInstituteName,TDT.MG_d2_UpdatedBy,TDT.MG_d2_ExternalFacultyName,TDT.MG_d2_ProjectDetailsID,TDT.MG_d2_ExternalEmailId,TDT.MG_d2_ExternalContactNo,TDT.MG_d2_DesignationID,TDT.MG_d2_AdditionalID,TDT.MG_d2_UpdatedOn,TDT.MG_d2_ExternalDesignation,TDT.MG_d2_AdditionalType FROM @TBL_FC9B8D2E9EE3436FAF08A774AF04D678 TDT
							LEFT JOIN [FC9B8D2E-9EE3-436F-AF08-A774AF04D678] DT  WITH(NOLOCK)
							ON	TDT.RowId=DT.RowId WHERE DT.RowId IS NULL;";

                                     colList=@"InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_d2_ExternalInstituteName,MG_d2_UpdatedBy,MG_d2_ExternalFacultyName,MG_d2_ProjectDetailsID,MG_d2_ExternalEmailId,MG_d2_ExternalContactNo,MG_d2_DesignationID,MG_d2_AdditionalID,MG_d2_UpdatedOn,MG_d2_ExternalDesignation,MG_d2_AdditionalType";

                                     tempInsertQuery=@"INSERT INTO @TBL_FC9B8D2E9EE3436FAF08A774AF04D678(InstanceId,ProcessActivityMapId,GridId,RowId,Sequence,MG_d2_ExternalInstituteName,MG_d2_UpdatedBy,MG_d2_ExternalFacultyName,MG_d2_ProjectDetailsID,MG_d2_ExternalEmailId,MG_d2_ExternalContactNo,MG_d2_DesignationID,MG_d2_AdditionalID,MG_d2_UpdatedOn,MG_d2_ExternalDesignation,MG_d2_AdditionalType)VALUES({0});";
